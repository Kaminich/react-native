...
const CommentRoomText2 = () => {
  return (
    <View style={styles.commentRoomText}>
...
Combo `}</Text>
      ...
      <View style={styles.commentRoomTextChild} />
...
`}</Text>
                  <Text style={styles.camThNtChunMngThLu}> </Text>
                </Text>
        ...
        <View style={styles.actionSheetfooter}>
          <View style={styles.buttonParent}>
            ...
            <View style={[styles.button2, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text14, styles.textTypo]}>Gửi tin nhắn</Text>
              <Image
                style={[styles.iconsetplaceholder3, styles.leftIconLayout]}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder2.png")}
...
export default CommentRoomText2;
