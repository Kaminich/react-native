...
const CommentRoomSend2 = () => {
  return (
    <View style={[styles.commentRoomSend, styles.composerBg]}>
          ...
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              ...
              <View style={styles.logMessagenormal}>
                <Text style={[styles.bnAngPhnContainer, styles.bn1Layout]}>
                  <Text style={[styles.bn, styles.bnTypo]}>Bạn</Text>
                  <Text style={styles.angPhnHiBnhLunCaNg}>
                    <Text
                      style={styles.angPhnHi}
                    >{` đang phản hồi bình luận của người dùng về bài viết trên trang `}</Text>
                    <Text style={styles.internetCameraFpt}>
                      “Internet Camera FPT”
                    </Text>
                    <Text style={styles.angPhnHi}>{`. 
`}</Text>
                  </Text>
                  <Text style={[styles.xemBnhLun, styles.bnTypo]}>
                    Xem bình luận
                  </Text>
              ...
              <View style={[styles.messageitem1, styles.messageitemLayout]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  ...
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.bn1Layout]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
            ...
            <View style={[styles.messagelogAction1, styles.messagecellFlexBox]}>
              <Text style={[styles.time, styles.timeClr]}>12:05</Text>
              <View style={styles.logMessagenormal}>
                <Text style={[styles.bn1, styles.bnTypo]}>Bạn</Text>
                <Text style={[styles.honTtCuc, styles.bn1Layout]}>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.bn1Layout]}>
...
export default CommentRoomSend2;
