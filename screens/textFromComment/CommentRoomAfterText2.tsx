...
const CommentRoomAfterText2 = () => {
  return (
    <View style={[styles.commentRoomAfterText, styles.commentRoomAfterTextLayout]}>
          ...
          <View style={[styles.layoutBlocksVertical, styles.postSpaceBlock]}>
            <View style={styles.commentcell}>
              ...
              <View style={styles.comment}>
                ...
                >
                  <Image
                    style={[styles.image1Icon, styles.commentRoomAfterTextLayout]}
                    resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  commentRoomAfterText: {
    height: 812,
    backgroundColor: Color.textWhite,
  },
});

export default CommentRoomAfterText2;
