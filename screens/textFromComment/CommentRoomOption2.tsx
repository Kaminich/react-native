...
const CommentRoomOption2 = () => {
  return (
    <View style={styles.commentRoomOption}>
      <View style={[styles.roomheaderParent, styles.commentRoomOptionChildPosition]}>
...
Combo `}</Text>
      ...
      <View style={[styles.commentRoomOptionChild, styles.homeIndicatorBg]} />
      <View style={[styles.actionSheetcomment, styles.homeindicator1Position]}>
        <View style={styles.actionSheetreactions}>
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
          ...
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji12.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji13.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji14.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji15.png")}
          />
        </View>
        <View style={[styles.actionSheetlistCell, styles.actionSpaceBlock]}>
          <Image
            style={[styles.likeIcon2, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../../assets/1-like.png")}
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label8, styles.cnLi4Typo]}>Thích</Text>
        ...
        <View style={[styles.actionSheetlistCell1, styles.actionSpaceBlock]}>
          <Image
            style={[styles.likeIcon2, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../../assets/arrow-reply2.png")}
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label8, styles.cnLi4Typo]}>Trả lời</Text>
            <View style={[styles.icon20x20, styles.iconLayout1]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell2, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label8, styles.cnLi4Typo]}>Nhắn tin</Text>
            <View style={[styles.icon20x20, styles.iconLayout1]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell3, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label8, styles.cnLi4Typo]}>Sao chép</Text>
            <View style={[styles.icon20x20, styles.iconLayout1]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell4, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label8, styles.cnLi4Typo]}>Ẩn</Text>
            <View style={[styles.icon20x20, styles.iconLayout1]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell5, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label8, styles.cnLi4Typo]}>Xóa</Text>
            <View style={[styles.icon20x20, styles.iconLayout1]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell6, styles.actionSpaceBlock]}>
          <Image
            style={[styles.likeIcon2, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../../assets/block-user1.png")}
          />
          <View style={styles.labelParent}>
...
const styles = StyleSheet.create({
  commentRoomOptionChildPosition: {
    left: 0,
    width: 375,
  },
  composerFlexBox: {
...
export default CommentRoomOption2;
