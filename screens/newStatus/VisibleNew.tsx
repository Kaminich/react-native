...
Combo `}</Text>
                  ...
                  <View style={[styles.reacted, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji40.png")}
                      />
                      <Image
                      ...
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji41.png")}
                      />
                      <Image
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Image
              style={[styles.hourglassIcon, styles.iconLayout1]}
              resizeMode="cover"
