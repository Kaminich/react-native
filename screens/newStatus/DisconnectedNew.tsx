...
const DisconnectedNew = () => {
  return (
    <View style={styles.biVitNgtxaKtNi}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={styles.khungChat}>
          <View style={[styles.post, styles.postSpaceBlock]}>
            ...
            <Text style={[styles.camThNtContainer, styles.containerLayout]}>
...
Combo `}</Text>
            ...
            <View style={styles.timerpmParent}>
              <View style={styles.timerpm}>
                <Text style={[styles.text, styles.containerLayout]}>
                  01/06/2022
                </Text>
              </View>
              <View style={styles.hyperlink}>
                <Text style={[styles.xemBiVit, styles.containerLayout]}>
                  Xem bài viết
                </Text>
                <Image
          ...
          <View style={[styles.layoutBlocksVertical, styles.postSpaceBlock]}>
                  ...
                  <View style={styles.option}>
                    ...
                    <View style={styles.arrowReplyParent}>
                      <Image
                        style={[styles.likeIcon, styles.iconLayout2]}
                        resizeMode="cover"
                        source={require("../../assets/arrow-reply4.png")}
                      />
                  ...
                  <View style={[styles.reacted, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji43.png")}
                      />
                      <Image
                      ...
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji44.png")}
                      />
                      <Image
                        style={[styles.emojiIcon4, styles.emojiIconLayout]}
                        resizeMode="cover"
                        source={require("../../assets/emoji42.png")}
                      />
                      <Image
            ...
            <View style={styles.messagelogAction}>
              ...
              <View style={[styles.logMessagenormal, styles.imageLayout]}>
                <Text style={[styles.bn, styles.containerLayout]}>Bạn</Text>
                <Text style={[styles.honTtCuc, styles.containerLayout]}>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text
              style={[styles.trangFptCameraContainer, styles.containerLayout]}
            >
              <Text style={styles.camThNt}>{`Trang `}</Text>
              <Text style={[styles.internetFpt, styles.xemTypo]}>
                FPT Camera tại Hà Nội
              </Text>
              <Text style={styles.camThNt}> đã bị ngắt/xóa kết nối.</Text>
            </Text>
          </View>
          <View style={[styles.composeBar1, styles.tree1FlexBox]}>
            ...
            <View style={[styles.composer, styles.composerFlexBox]}>
              ...
              <Image
                style={[styles.emojiIcon24, styles.emojiIcon24Position]}
                resizeMode="cover"
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.emojiIcon24Position]} />
          </View>
        </View>
      </View>
...
export default DisconnectedNew;
