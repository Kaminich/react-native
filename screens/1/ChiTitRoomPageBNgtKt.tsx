...
const ChiTitRoomPageBNgtKt = () => {
  return (
    <View style={[styles.chiTitRoomPageBNgtKt, styles.composerBg]}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text
              style={[styles.trangFptCameraContainer, styles.honTtCucLayout]}
            >
...
export default ChiTitRoomPageBNgtKt;
