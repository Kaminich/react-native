...
const ViewNgiMtRoomLogChiaC = () => {
  return (
    <View style={styles.viewNgiMtRoomLogChiaC}>
          ...
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              ...
              <View style={styles.logMessagenormal}>
                <Text style={[styles.bn, styles.huongntTypo]}>Bạn</Text>
            ...
            <View style={[styles.messagecell, styles.messagecellFlexBox]}>
              <View style={styles.avtFlexBox}>
                <Image
                  style={[styles.avtIcon, styles.avtLayout]}
                  resizeMode="cover"
                  source={require("../../assets/avt1.png")}
                />
              </View>
              <Text style={[styles.huongnt256, styles.huongntTypo]}>
                HuongNT256
              </Text>
            ...
            <View style={styles.messagecellFlexBox}>
              ...
              <View style={styles.logMessagenormal1}>
                <Text style={[styles.bn, styles.huongntTypo]}>Bạn</Text>
                <Text
                  style={[styles.chiaChatCho, styles.textLayout]}
                >{`đã chia chat cho `}</Text>
                <Text style={[styles.huongnt2561, styles.huongntTypo]}>
                  HuongNT256
                </Text>
              </View>
            </View>
            <View style={[styles.messagecell, styles.messagecellFlexBox]}>
              <View style={styles.avtFlexBox}>
                <View style={[styles.avt2, styles.avtLayout]}>
                  <Text style={[styles.k, styles.textLayout]}>H</Text>
                </View>
              </View>
              <View style={styles.huongnt256Parent}>
                <Text style={[styles.huongnt2562, styles.labelLayout]}>
                  HuongNT256
                </Text>
                <View style={styles.messagevertical}>
                  ...
                  <View
                    style={[styles.messageitem2, styles.messageitemPosition]}
                  >
                    <View
                      style={[styles.messageTypetext, styles.messageFlexBox]}
                    >
                  ...
                  <View
                    style={[styles.messageitem3, styles.messageitemPosition]}
                  >
                    <View style={styles.messageTypeimageGroup}>
                      ...
                      <View style={styles.messageTypeimage1}>
                        <Image
                          style={styles.imgIcon}
                          resizeMode="cover"
                          source={require("../../assets/img26.png")}
            ...
            <View style={[styles.messagecell, styles.messagecellFlexBox]}>
              ...
              <View style={styles.huongnt256Parent}>
                ...
                <View style={[styles.messageitem4, styles.messageitemLayout]}>
            ...
            <View style={[styles.messagecell3, styles.messagecellFlexBox]}>
              <View style={[styles.messageitem5, styles.messageitemLayout]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  <Image
                    style={styles.warningIconLayout}
                    resizeMode="cover"
              ...
              <View style={[styles.status, styles.avtFlexBox1]}>
                <Image
                  style={[styles.messagestatusIcon, styles.squareIconLayout]}
                  resizeMode="cover"
                  source={require("../../assets/messagestatus.png")}
                />
              </View>
            </View>
            <View style={[styles.messagelogAction3, styles.messagecellFlexBox]}>
              <Text style={[styles.time, styles.textClr]}>12:05</Text>
              <View style={styles.logMessagenormal1}>
                <Text style={[styles.bn, styles.huongntTypo]}>Bạn</Text>
                <Text
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.textLayout]}>
              <Text style={[styles.halt82, styles.huongntTypo]}>HaLT82</Text>
              <Text style={styles.phnHiKhch}>
                {" "}
                đã phản hồi khách hàng. Bạn chỉ có thể theo dõi cuộc trò chuyện
              </Text>
            </Text>
          </View>
      ...
      <View style={styles.viewNgiMtRoomLogChiaCChild} />
          ...
          <View style={styles.activityFeed}>
            <View style={styles.activityFeedLog}>
              <Image
                ...
                resizeMode="cover"
                source={require("../../assets/frame-42731876729.png")}
              />
              <View style={styles.nameParent}>
                ...
                <View style={styles.count}>
                  <View style={[styles.tinNhn, styles.tinNhnSpaceBlock]}>
                    ...
                    />
                    <Text style={[styles.text3, styles.labelLayout]}>12</Text>
                  </View>
...
export default ViewNgiMtRoomLogChiaC;
