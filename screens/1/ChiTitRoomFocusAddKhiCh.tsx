...
const ChiTitRoomFocusAddKhiCh = () => {
  return (
    <View style={styles.chiTitRoomFocusAddKhiCh}>
        ...
        <View style={styles.composeBar}>
          ...
          <View style={styles.actionSheetcomposer}>
            ...
            <View style={[styles.actionSheetlistCell, styles.actionSpaceBlock]}>
              ...
              />
              <View style={styles.labelParent}>
                <Text style={[styles.label7, styles.labelTypo]}>Camera</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
            ...
            <View style={styles.actionSpaceBlock}>
              ...
              />
              <View style={styles.labelParent}>
                <Text style={[styles.label7, styles.labelTypo]}>Nhãn dán</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
            ...
            <View style={styles.actionSpaceBlock}>
              ...
              />
              <View style={styles.labelParent}>
                <Text style={[styles.label7, styles.labelTypo]}>GIF</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
...
export default ChiTitRoomFocusAddKhiCh;
