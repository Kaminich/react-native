    ...
    <View style={styles.listRoom}>
      <View style={styles.header3Parent}>
        <View style={styles.header3}>
          ...
          <View style={[styles.pageParent, styles.listRoom1SpaceBlock]}>
        ...
        <View style={[styles.listRoom1, styles.listRoom1SpaceBlock]}>
          ...
          <View style={styles.roomitem}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/roommessageavt24.png")}
            />
              ...
              <View style={styles.roomNameParent}>
                ...
                <View style={styles.page1}>
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../../assets/iconright2.png")}
                  />
                  <Image
          ...
          <View style={styles.roomitem}>
            <Image
              style={styles.roommessageavtIcon}
              resizeMode="cover"
              source={require("../../assets/roommessageavt25.png")}
            />
            <View style={styles.content}>
              <View style={styles.roomNameParent}>
                <View style={styles.roomName}>
          ...
          <View style={styles.roomitem}>
            <Image
              style={styles.roommessageavtIcon}
              resizeMode="cover"
              source={require("../../assets/roommessageavt45.png")}
            />
            <View style={styles.content}>
              <View style={styles.roomNameParent}>
                <View style={styles.roomName}>
          ...
          <View style={styles.roomitem}>
            <Image
              style={styles.roommessageavtIcon}
              resizeMode="cover"
              source={require("../../assets/roommessageavt46.png")}
            />
            <View style={styles.content}>
              <View style={styles.roomNameParent}>
                <View style={styles.roomName}>
        ...
        <View style={styles.tabControl}>
          ...
          <View style={styles.tabBar1}>
            <Image
              style={styles.menuIcon}
              resizeMode="cover"
              source={require("../../assets/menu-icon34.png")}
            />
