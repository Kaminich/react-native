...
const ChiTitRoomMessQuDungL = () => {
  return (
    <View style={styles.chiTitRoomMessQuDungL}>
        ...
        <View style={styles.roomheader}>
          ...
          <View style={styles.room}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/roommessageavt48.png")}
            />
      ...
      <View
        style={[styles.chiTitRoomMessQuDungLChild, styles.homeIndicatorBg]}
      />
          ...
          <View style={styles.messagelogAction}>
            ...
            <View style={styles.titleParent}>
              ...
              <Text style={[styles.text2, styles.bnLayout]}>
                Messenger hỗ trợ định dạng: doc, docx, xlsx , xls, ppt, pptx,
                pdf, jpg, png, heif, heic, jpeg, tiff, tif, webp, gif, mp3, mp4,
                wav, m4a, wma, flac với dung lượng tối đa 25MB
              </Text>
            </View>
          </View>
...
export default ChiTitRoomMessQuDungL;
