...
const ChiTitRoom1 = () => {
  return (
    <View style={styles.chiTitRoom}>
      ...
      <View style={[styles.actionSheetmessage, styles.homeindicator1Position]}>
        <View style={styles.actionSheetreactions}>
          <Image
            style={styles.emojiIcon1}
            resizeMode="cover"
            source={require("../../assets/emoji45.png")}
          />
          <Image
            style={styles.emojiIcon1}
            resizeMode="cover"
            source={require("../../assets/emoji46.png")}
          />
          <Image
            style={styles.emojiIcon1}
            resizeMode="cover"
            source={require("../../assets/emoji47.png")}
          />
          <Image
            style={styles.emojiIcon1}
            resizeMode="cover"
            source={require("../../assets/emoji48.png")}
          />
          <Image
            style={styles.emojiIcon1}
            resizeMode="cover"
            source={require("../../assets/emoji49.png")}
          />
          <Image
            style={styles.emojiIcon1}
            resizeMode="cover"
            source={require("../../assets/emoji50.png")}
          />
          <Image
            style={styles.emojiIcon1}
            resizeMode="cover"
            source={require("../../assets/emoji51.png")}
          />
        </View>
        <View style={[styles.actionSheetlistCell, styles.actionSpaceBlock]}>
          <Image
            style={[styles.arrowReplyIcon, styles.iconLayout]}
            resizeMode="cover"
            source={require("../../assets/arrow-reply.png")}
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label7, styles.labelTypo]}>Trả lời</Text>
        ...
        <View style={[styles.actionSheetlistCell1, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label7, styles.labelTypo]}>Sao chép</Text>
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell2, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label7, styles.labelTypo]}>Chuyển tiếp</Text>
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell3, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label7, styles.labelTypo]}>Xóa, Thu hồi</Text>
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={styles.illustration} />
            </View>
          </View>
