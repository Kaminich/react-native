...
const ChNhChatTi = () => {
  return (
    <View style={[styles.chNhChatTi, styles.titleLayout]}>
      <View style={styles.roomheaderParent}>
          ...
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              ...
              <View style={[styles.logMessagenormal, styles.logFlexBox]}>
                ...
                <Text style={[styles.honTtCuc, styles.kTypo]}>
              ...
              <View style={[styles.messageitem1, styles.messageitemLayout]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  ...
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.kTypo]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.kTypo]}>
      ...
      <View style={styles.chNhChatTiChild} />
        ...
        <View style={styles.listAgent}>
          <View style={[styles.fieldinputParent, styles.roomheaderSpaceBlock]}>
            <View style={[styles.fieldinput, styles.button1Border]}>
              ...
              />
              <Text style={[styles.text2, styles.kTypo]}>Tìm kiếm</Text>
              <Image
                style={[styles.ficheckSquareIcon, styles.iconLayout]}
                resizeMode="cover"
            ...
            <View style={styles.selectedWrapper}>
              <View style={styles.selected}>
                ...
                />
                <Text style={[styles.name1, styles.kbTypo]}>Tôi (HaDT53)</Text>
              </View>
            </View>
          </View>
          <View style={styles.listAgent1}>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.bnTypo]}>Tôi (HaDT53)</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <Image
                style={[styles.radioIcon, styles.radioLayout1]}
                resizeMode="cover"
            ...
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>HaLT82</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>HiepNH21</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>HuongNT256</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>MinhPD11</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>NguyetNB2</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>NhungVTH15</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>QuanDV17</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>QuangDD16</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>SangTT9</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>ThucPT3</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>TriLM22</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name3, styles.kTypo]}>VanNT99</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioLayout]} />
            </View>
