...
const ChiTitRoomChnSticker = () => {
  return (
    <View style={[styles.chiTitRoomChnSticker, styles.composerBg]}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={[styles.khungChat, styles.composerBg]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={[styles.messagecell1, styles.messagecellFlexBox]}>
              <View style={styles.messageitem5}>
...
const styles = StyleSheet.create({
  ...
  chiTitRoomChnSticker: {
    width: "100%",
    height: 681,
  },
});

export default ChiTitRoomChnSticker;
