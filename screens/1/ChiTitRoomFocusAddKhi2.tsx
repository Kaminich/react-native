          ...
          <View style={styles.actionSheetcomposer}>
            ...
            >
              ...
              <View style={styles.labelParent}>
                <Text style={styles.label7}>Thư viện ảnh</Text>
            ...
            >
              ...
              />
              <View style={styles.labelParent}>
                <Text style={styles.label7}>Camera</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
            ...
            >
              ...
              />
              <View style={styles.labelParent}>
                <Text style={styles.label7}>Tệp đính kèm</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
            ...
            >
              ...
              />
              <View style={styles.labelParent}>
                <Text style={styles.label7}>Nhãn dán</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
            ...
            >
              ...
              />
              <View style={styles.labelParent}>
                <Text style={styles.label7}>GIF</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
            ...
            >
              ...
              />
              <View style={styles.labelParent}>
                <Text style={styles.label7}>Trả lời mẫu</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
...
export default ChiTitRoomFocusAddKhi2;
