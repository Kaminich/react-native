...
const NhNgang = () => {
  return (
    <View style={styles.nhNgang}>
      <View style={[styles.roomheaderParent, styles.nhNgangChildPosition]}>
      ...
      <View style={[styles.nhNgangChild, styles.nhNgangChildPosition]} />
      <Image
      ...
      <View
        style={[styles.statusbarIphone14Parent, styles.homeindicator1Position]}
      >
        <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
          <Image
            style={[styles.notchIcon, styles.notchIconPosition]}
        ...
        <Image
          style={[styles.leftIcon1, styles.iconPosition]}
          resizeMode="cover"
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../../assets/15-upload1.png")}
        />
      </View>
    </View>
  );
