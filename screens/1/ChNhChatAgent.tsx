...
const ChNhChatAgent = () => {
  return (
    <View style={[styles.chNhChatAgent, styles.titleLayout]}>
      <View style={styles.roomheaderParent}>
        <View style={[styles.roomheader, styles.roomheaderSpaceBlock]}>
          ...
          <View style={styles.room}>
            <Image
              style={[styles.roommessageavtIcon, styles.avt3Layout]}
              resizeMode="cover"
            ...
            <View style={styles.nameParent}>
              <View style={styles.name}>
                ...
                <View style={styles.returnVisitorParent}>
                  ...
                  />
                  <Text style={[styles.lMinhTr, styles.kLayout]}>
                    Lê Minh Trí
                  </Text>
                  <Image
          ...
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              ...
              <View style={[styles.logMessagenormal, styles.logFlexBox]}>
                ...
                <Text style={[styles.honTtCuc, styles.k1Typo]}>
            ...
            <View style={[styles.messagecell1, styles.messagecellFlexBox]}>
              <View style={[styles.messageitem1, styles.button2Bg]}>
                <View style={[styles.messageTypetext, styles.messageFlexBox]}>
              ...
              <View style={[styles.messageitem1, styles.button2Bg]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  ...
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.k1Typo]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.k1Typo]}>
      ...
      <View style={styles.chNhChatAgentChild} />
      <View style={[styles.actionSheetchNhChat, styles.actionPosition]}>
        ...
        <View style={styles.listAgent}>
          <View style={[styles.fieldinputParent, styles.roomheaderSpaceBlock]}>
            <View style={[styles.fieldinput, styles.button1Border]}>
              <Image
                style={[styles.searchIcon, styles.iconLayout]}
                resizeMode="cover"
                source={require("../../assets/1-search2.png")}
              />
              <Text style={[styles.text2, styles.k1Typo]}>Tìm kiếm</Text>
              <Image
                style={[styles.ficheckSquareIcon, styles.iconLayout]}
                resizeMode="cover"
            ...
            <View style={styles.selectedWrapper}>
              <View style={styles.selected}>
                <View style={[styles.roommessageavtIcon, styles.avt3Layout]}>
                  <View style={[styles.avt3, styles.avtSpaceBlock]}>
                    <Text style={[styles.k, styles.kLayout]}>H</Text>
                  </View>
                  <Image
                    style={[styles.validateIcon, styles.iconLayout1]}
                    resizeMode="cover"
                    source={require("../../assets/validate9.png")}
                  />
                </View>
                <Text style={[styles.name1, styles.labelTypo]}>HiepNH21</Text>
              </View>
            </View>
          </View>
          <View style={styles.listAgent1}>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>Tôi (HaDT53)</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={[styles.radio, styles.radioBorder]} />
            </View>
            <View style={styles.dropdownitem}>
              <Image
                style={styles.avtIcon3}
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>HaLT82</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              <View style={[styles.avt4, styles.avtSpaceBlock]}>
                <Text style={[styles.k1, styles.k1Typo]}>H</Text>
              </View>
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name4, styles.bnTypo]}>HiepNH21</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <Image
            ...
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>HuongNT256</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              <View style={[styles.avt4, styles.avtSpaceBlock]}>
                <Text style={[styles.k1, styles.k1Typo]}>M</Text>
              </View>
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>MinhPD11</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>NguyetNB2</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              <View style={[styles.avt4, styles.avtSpaceBlock]}>
                <Text style={[styles.k1, styles.k1Typo]}>N</Text>
              </View>
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>NhungVTH15</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>QuanDV17</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              <View style={[styles.avt4, styles.avtSpaceBlock]}>
                <Text style={[styles.k1, styles.k1Typo]}>Q</Text>
              </View>
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>QuangDD16</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>SangTT9</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              <View style={[styles.avt4, styles.avtSpaceBlock]}>
                <Text style={[styles.k1, styles.k1Typo]}>T</Text>
              </View>
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>ThucPT3</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>TriLM22</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
            <View style={styles.dropdownitem}>
              <View style={[styles.avt4, styles.avtSpaceBlock]}>
                <Text style={[styles.k1, styles.k1Typo]}>V</Text>
              </View>
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.k1Typo]}>VanNT99</Text>
                <Text style={[styles.text3, styles.timeClr]}>Second line</Text>
              </View>
              <View style={styles.radioBorder} />
            </View>
        ...
        <View style={styles.actionSheetfooter}>
          <View style={styles.buttonParent}>
            <View style={[styles.button1, styles.button1Border]}>
              <Image
                style={[styles.iconsetplaceholder, styles.leftIconLayout]}
                resizeMode="cover"
            ...
            <View style={[styles.button2, styles.button2Bg]}>
              <Image
                style={[styles.iconsetplaceholder, styles.leftIconLayout]}
                resizeMode="cover"
