      ...
      <View style={styles.chiTitRoom}>
            ...
            <View style={styles.tabControl}>
              ...
              <View style={styles.tabFlexBox}>
                <Image
                  ...
                  source={require("../../assets/social31.png")}
                />
                <Text style={styles.label10}>Tab 1</Text>
              ...
              <View style={styles.customerInfoavt}>
                ...
                <View style={styles.row1Parent}>
                  ...
                  <View style={styles.row2}>
                    <Text style={styles.angOnline}>Đang online</Text>
                  </View>
                  <View style={styles.button}>
                    <Text style={styles.label15}>
        ...
        <View style={styles.ghiCh}>
          <View style={styles.fieldtextArea}>
            <Text style={styles.text5}>{`Nhập ghi chú
          ...
          <View style={styles.lchSGhiCh}>
            ...
            <View style={styles.lchSGhiCh1}>
              <View style={styles.avt}>
                <Text style={styles.label15}>H</Text>
              </View>
      ...
      <View style={[styles.actionSheet, styles.tabBarPosition]}>
        <View style={[styles.actionSheetheader, styles.leftParentSpaceBlock]}>
          ...
          <View style={styles.titleWrapper}>
            <Text style={[styles.title1, styles.name1Typo]} numberOfLines={1}>
              Hoạt động
            </Text>
          </View>
          <View style={styles.button1}>
            ...
            />
            <Text style={[styles.text7, styles.name1Typo]}>Lưu</Text>
            <Image
          ...
          <View style={styles.activityFeed}>
            <View style={styles.activityFeedLog}>
              <Image
                ...
                resizeMode="cover"
                source={require("../../assets/frame-42731876723.png")}
              />
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  <Text style={styles.text8}>01/06/2022 11:00:03</Text>
                  <Image
                ...
                <View style={styles.content}>
                  <Text style={[styles.user, styles.fptTypo]}>Lê Minh Trí</Text>
                  <Text style={styles.action}>nhắn tin</Text>
                  <Text
            ...
            <View style={styles.logCon}>
              <View style={styles.activityFeedLog}>
                ...
                <View style={styles.content1}>
                  <Image
                    style={styles.iconLayout1}
                    resizeMode="cover"
                    source={require("../../assets/activity-feed--icon16.png")}
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>01/06/2022 11:00:03</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        Lê Minh Trí
                      </Text>
                      <Text style={styles.action}>nhắn tin</Text>
                      <Text
                        style={[styles.object, styles.fptTypo]}
                        numberOfLines={1}
                      >
                        FPT Camera Hà Nội...
                      </Text>
              ...
              <View style={styles.activitySpaceBlock}>
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>01/06/2022 11:04:45</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>HaDT53</Text>
                      <Text style={styles.action}>đã chỉ định chat cho</Text>
                      <Text
                        style={[styles.fptCameraH, styles.fptTypo]}
                        numberOfLines={1}
                      >{`HuongNT256 `}</Text>
              ...
              <View
                style={[styles.activityFeedLog3, styles.activitySpaceBlock]}
              >
                <Image
                  style={styles.activityFeedLogChild}
                  resizeMode="cover"
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>01/06/2022 11:30:22</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        HuongNT256
                      </Text>
                      <Text style={styles.action}>nhắc nhở</Text>
                      <Text
                        style={[styles.object, styles.fptTypo]}
                        numberOfLines={1}
                      >
              ...
              <View style={styles.activitySpaceBlock}>
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>01/06/2022 12:05:22</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        HuongNT256
                      </Text>
                      <Text style={styles.action}>đã tạo đơn hàng</Text>
                      <Text
                        style={[styles.object, styles.fptTypo]}
                        numberOfLines={1}
                      >
              ...
              >
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>02/06/2022 12:00:15</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        Lê Minh Trí
                      </Text>
              ...
              >
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>02/06/2022 12:01:15</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        HuongNT256
                      </Text>
                      <Text style={styles.action}>đã chặn</Text>
                      <Text
                        style={[styles.fptCameraH, styles.fptTypo]}
                        numberOfLines={1}
                      >
              ...
              >
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>02/06/2022 12:02:15</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        HuongNT256
                      </Text>
                      <Text style={styles.action}>đã bỏ chặn</Text>
                      <Text
                        style={[styles.fptCameraH, styles.fptTypo]}
                        numberOfLines={1}
                      >
              ...
              >
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>02/06/2022 13:00:11</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        HuongNT256
                      </Text>
                      <Text style={styles.action}>hoàn tất</Text>
                      <Text
                        style={[styles.object, styles.fptTypo]}
                        numberOfLines={1}
                      >
              ...
              >
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>02/06/2022 14:00:42</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>
                        HuongNT256
                      </Text>
                      <Text style={styles.action}>mở lại</Text>
                      <Text
                        style={[styles.object, styles.fptTypo]}
                        numberOfLines={1}
                      >
              ...
              >
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>03/06/2022 08:34:00</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>HaDT53</Text>
                      <Text style={styles.action}>đã chỉ định chat cho</Text>
                      <Text
              ...
              >
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <View style={styles.hyperlink}>
                    <Text style={styles.text11}>03/06/2022 08:35:00</Text>
                    <View style={[styles.content2, styles.content2SpaceBlock]}>
                      <Text style={[styles.user, styles.fptTypo]}>HaDT53</Text>
                      <Text style={styles.action}>đã chỉ định chat cho</Text>
                      <Text
          ...
          <View style={styles.activityFeed1}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-42731876724.png")}
              />
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  <Text style={styles.text8}>01/06/2022 11:00:03</Text>
          ...
          <View style={styles.activityFeed1}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-42731876725.png")}
              />
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  <Text style={styles.text8}>31/05/2022 11:00:03</Text>
                  <Image
                    style={[styles.warningIcon, styles.iconLayout1]}
                    resizeMode="cover"
                    source={require("../../assets/4-warning2.png")}
                ...
                <View style={styles.content}>
                  <Text style={[styles.user, styles.fptTypo]}>Lê Minh Trí</Text>
                  <Text style={styles.action}>đã truy cập</Text>
                  <Text
            ...
            <View style={styles.activityFeedLog16}>
              ...
              <View style={styles.content1}>
                ...
                <View style={styles.hyperlink}>
                  <View style={styles.frameView}>
                    <Text style={styles.ltXemTrang}>Lượt xem trang: 4</Text>
                    <Image
                      style={[styles.iconRoom, styles.iconLayout1]}
                      resizeMode="cover"
          ...
          <View style={styles.activityFeed1}>
            <View style={styles.activityFeedLog}>
              ...
              <View style={styles.frameParent1}>
                ...
                <View style={styles.content}>
                  <Text style={[styles.user, styles.fptTypo]}>Lê Minh Trí</Text>
                  <Text style={styles.action}>bình luận</Text>
                  <Text
                    style={[styles.fptCameraH, styles.fptTypo]}
                    numberOfLines={1}
                  >
        ...
        <View style={styles.actionSheetfooter}>
          <View style={styles.buttonParent}>
            <View style={[styles.button2, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text40, styles.textTypo]}>Secondary</Text>
              <Image
            ...
            <View style={[styles.button3, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text41, styles.textTypo]}>Primary</Text>
              <Image
                style={styles.iconsetplaceholder3}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder5.png")}
