...
const ToNHngThnhCng = () => {
  return (
    <View style={[styles.toNHngThnhCng, styles.composerBg]}>
      <View style={styles.roomheaderParent}>
          ...
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              ...
              <View style={[styles.logMessagenormal, styles.logFlexBox]}>
                ...
                <Text style={[styles.honTtCuc, styles.toNHngTypo]}>
              ...
              <View style={[styles.messageitem1, styles.messageitemLayout]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  ...
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.toNHngTypo]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
            ...
            <View style={styles.messagecellFlexBox}>
              ...
              <View style={styles.logFlexBox}>
                <Text style={styles.bnTypo}>Bạn</Text>
                <Text style={[styles.toNHng, styles.toNHngTypo]}>
                  đã tạo đơn hàng
                </Text>
                <Text style={[styles.giDchV, styles.bnTypo]}>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.toNHngTypo]}>
