...
const ToNHnConfirm = () => {
  return (
    <View style={styles.toNHnConfirm}>
      ...
      <View
        style={[styles.toNHnConfirmChild, styles.roomheaderParentPosition]}
      />
        ...
        <View style={styles.contentParent}>
          <View style={styles.messagelogAction}>
            ...
            <View style={styles.titleParent}>
              ...
              <Text style={[styles.text1, styles.text1Typo]}>
                ...
                thông tin khách hàng sẽ tự động điền (nếu có)
              </Text>
            </View>
          </View>
          <View style={styles.buttonGroup}>
            ...
            <View style={[styles.button1, styles.icon1FlexBox]}>
              ...
              />
              <Text style={[styles.text3, styles.textTypo]}>Mở ứng dụng</Text>
              <Image
                style={[styles.iconsetplaceholder1, styles.iconLayout2]}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder8.png")}
