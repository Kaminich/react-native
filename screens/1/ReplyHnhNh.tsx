...
const ReplyHnhNh = () => {
  return (
    <View style={[styles.replyHnhNh, styles.imgIcon1Layout]}>
              ...
              <View style={styles.messageitem}>
                <View style={styles.messageTypeimage}>
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../../assets/img27.png")}
                  />
                </View>
              </View>
            </View>
                    ...
                    >
                      <View style={styles.replyType}>
                        <View style={styles.messageTypeimage1}>
                          <Image
                            style={[styles.imgIcon1, styles.imgIcon1Layout]}
                            resizeMode="cover"
                            source={require("../../assets/img28.png")}
                          />
                        </View>
                      </View>
                    </View>
