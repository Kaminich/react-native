  ...
  return (
    <View style={[styles.nHng, styles.nHngLayout]}>
      <View style={styles.frameParent}>
        <View style={[styles.frameWrapper, styles.dsNHngSpaceBlock]}>
      ...
      <View style={styles.chiTitRoom}>
          ...
          >
            ...
            <View style={styles.tabControl}>
              <View style={[styles.tab, styles.tabFlexBox]}>
                ...
                />
                <Text style={[styles.label9, styles.label9Typo]}>Tab 1</Text>
              ...
              <View style={styles.tabFlexBox}>
                ...
                <View style={[styles.badge1, styles.iconLayout]}>
        ...
        <View style={styles.ghiCh}>
          <View style={[styles.fieldtextArea, styles.tnKhFlexBox]}>
...
`}</Text>
            ...
            <View style={styles.lchSGhiCh1}>
              ...
              <View style={styles.frameContainer}>
                <View style={styles.frameView}>
                  <View style={styles.name}>
                    <Text style={[styles.huongnt256, styles.text6Layout]}>
                      HuongNT256
                    </Text>
                    <Image
        ...
        <View style={styles.tabBarParent}>
          <View style={styles.tabBar1}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/menu-icon36.png")}
            />
      ...
      <View style={[styles.actionSheet, styles.tabBarPosition]}>
        ...
        <View style={[styles.dsNHng, styles.dsNHngSpaceBlock]}>
          <View style={[styles.nHng1, styles.hngBorder]}>
            <View style={[styles.tnKh, styles.tnKhFlexBox]}>
              <Text style={[styles.lMinhTr, styles.textTypo]}>Lê Minh Trí</Text>
              <View style={styles.nHngstatus}>
                <View style={[styles.tag3, styles.tagFlexBox]}>
                  <Text style={[styles.label31, styles.text6Layout]}>
                    Đã tạo đơn hàng
                  </Text>
                  <Image
            ...
            <View style={styles.frameParent1}>
              <View style={[styles.nHngdchVParent, styles.button1FlexBox]}>
                <Image
                  style={[styles.nHngdchV, styles.leftIconLayout]}
                  resizeMode="cover"
                  source={require("../../assets/n-hngdch-v.png")}
                />
                <Text style={[styles.giDchV, styles.label9Typo]}>
                  Gói dịch vụ FPT Play Box
                </Text>
              </View>
              <View style={styles.frameParent2}>
                <View style={styles.nHngiconParent}>
                  <Image
                    style={[styles.nHngicon, styles.iconLayout1]}
                    resizeMode="cover"
                ...
                <Image
                  style={styles.line6Stroke}
                  resizeMode="cover"
                  source={require("../../assets/line-6-stroke.png")}
                />
                <View style={styles.nHngiconGroup}>
                  <Image
                    style={styles.iconLayout1}
                    resizeMode="cover"
          ...
          <View style={[styles.nHng2, styles.hngBorder]}>
            <View style={[styles.tnKh, styles.tnKhFlexBox]}>
              <Text style={[styles.lMinhTr, styles.textTypo]}>Lê Minh Trí</Text>
              <View style={styles.nHngstatus}>
            ...
            <View style={styles.frameParent1}>
              ...
              <View style={styles.frameParent2}>
                ...
                <Image
                  style={styles.line6Stroke2}
                  resizeMode="cover"
                  source={require("../../assets/line-6-stroke.png")}
                />
                <View style={styles.nHngiconParent3}>
                  <Image
                    style={styles.iconLayout1}
                    resizeMode="cover"
                    source={require("../../assets/n-hngicon1.png")}
          ...
          <View style={[styles.nHng2, styles.hngBorder]}>
            <View style={[styles.tnKh, styles.tnKhFlexBox]}>
              <Text style={[styles.lMinhTr, styles.textTypo]}>Lê Minh Trí</Text>
              <View style={styles.nHngstatus}>
                <View style={[styles.tag33, styles.tagFlexBox]}>
                  <Text style={[styles.label31, styles.text6Layout]}>
                    Đã huỷ
                  </Text>
                  <Image
        ...
        <View style={styles.actionSheetfooter}>
          <View style={styles.buttonParent}>
            <View style={[styles.button2, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text12, styles.textTypo]}>Secondary</Text>
              <Image
            ...
            <View style={[styles.button3, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text13, styles.textTypo]}>Primary</Text>
              <Image
                style={[styles.iconsetplaceholder3, styles.leftIconLayout]}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder5.png")}
