...
const ChNhChatThnhCng = () => {
  return (
    <View style={[styles.chNhChatThnhCng, styles.chatBg]}>
          ...
          <View style={styles.layoutBlocksVertical}>
              ...
              <View style={[styles.messageitem1, styles.messageitemLayout]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  ...
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.descriptionLayout]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
            ...
            <View style={styles.messagecellFlexBox}>
              ...
              <View style={[styles.logMessagenormal1, styles.logLayout]}>
                <Text style={styles.huongntTypo}>Bạn</Text>
                <Text
                  style={[styles.chNhChat, styles.descriptionLayout]}
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.descriptionLayout]}>
              ...
              <Text style={styles.huongnt2564}>HuongNT256</Text>
      ...
      <View style={[styles.toast, styles.logLayout]}>
        ...
        <View style={styles.titleParent}>
          <Text style={[styles.title, styles.titleTypo]}>Đã chỉ định chat</Text>
...
export default ChNhChatThnhCng;
