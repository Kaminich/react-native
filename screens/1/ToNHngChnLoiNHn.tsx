...
const ToNHngChnLoiNHn = () => {
  return (
    <View style={styles.toNHngChnLoiNHn}>
      ...
      <View style={styles.toNHngChnLoiNHnChild} />
      <View style={[styles.actionSheetroom, styles.actionLayout]}>
        <View style={[styles.actionSheetheader, styles.actionLayout]}>
          <Image
        ...
        <View style={styles.actionSheetlistCellParent}>
          <View style={styles.actionSheetlistCell}>
            <Image
            ...
            <View style={styles.labelParent}>
              <Text style={[styles.label7, styles.labelTypo]}>Bán thêm</Text>
          ...
          <View style={styles.actionSheetlistCell}>
            ...
            />
            <View style={styles.labelParent}>
              <Text style={[styles.label7, styles.labelTypo]}>Bán mới</Text>
              <View style={[styles.icon20x20, styles.iconLayout]}>
                <View style={styles.illustration} />
              </View>
            </View>
        ...
        <View style={[styles.actionSheetlistCell2, styles.actionSpaceBlock]}>
          <Image
            style={[styles.discountIcon, styles.iconLayout]}
            resizeMode="cover"
...
export default ToNHngChnLoiNHn;
