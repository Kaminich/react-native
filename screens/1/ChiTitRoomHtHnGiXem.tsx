...
const ChiTitRoomHtHnGiXem = () => {
  return (
    <View style={styles.chiTitRoomHtHnGiXem}>
        ...
        <View style={styles.composeBar}>
          <View style={[styles.helperText, styles.khungChatFlexBox]}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/validate6.png")}
            />
            <Text style={[styles.htThiHn, styles.bnLayout]}>
      ...
      <View style={[styles.chiTitRoomHtHnGiXemChild, styles.homeIndicatorBg]} />
        ...
        <View style={styles.contentParent}>
          <View style={styles.messagelogAction}>
            <View style={styles.confirmationIcon}>
              <Image
                style={styles.validateIcon1}
                resizeMode="cover"
                source={require("../../assets/validate5.png")}
              />
            </View>
            <View style={styles.titleParent}>
              <Text style={styles.title}>Hội thoại Facebook</Text>
              <Text style={[styles.text1, styles.bnLayout]}>
                <Text
                  style={styles.htThiHn1}
                >{`Đã hết thời hạn gửi tin nhắn cho khách hàng không tương tác với trang theo `}</Text>
                <Text style={[styles.iuKhonCa, styles.bnTypo]}>
                  Điều khoản của Facebook
                </Text>
                <Text style={styles.htThiHn1}>
                  . Bạn có thể sử dụng Facebook để phản hồi cho khách hàng.
                </Text>
              </Text>
            </View>
          </View>
...
export default ChiTitRoomHtHnGiXem;
