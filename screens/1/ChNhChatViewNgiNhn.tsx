...
const ChNhChatViewNgiNhn = () => {
  return (
    <View style={[styles.chNhChatViewNgiNhn, styles.chatBg]}>
          ...
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={styles.messagecellFlexBox}>
              ...
              <View style={styles.logFlexBox}>
                <Text style={styles.huongntTypo}>HuongNT256</Text>
                <Text
                  style={[styles.chNhChat, styles.honTtCucTypo]}
...
export default ChNhChatViewNgiNhn;
