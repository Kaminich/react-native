          ...
          <View style={styles.messagelogAction}>
            ...
            <View style={styles.titleParent}>
              ...
              <Text style={[styles.text2, styles.bnLayout]}>
                Trang của bạn đã bị Facebook hạn chế gửi tin nhắn, có thể do bạn
                đã sử dụng ứng dụng khác để gửi quá nhiều tin nhắn quảng cáo ưu
                đãi.
              </Text>
            </View>
          </View>
...
export default ChiTitRoomFail2;
