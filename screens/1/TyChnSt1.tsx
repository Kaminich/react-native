...
const TyChnSt1 = () => {
  return (
    <View style={styles.tyChnSt}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={styles.composeBar}>
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.tyChnStChildBg]} />
          </View>
        </View>
      </View>
      ...
      <View style={[styles.tyChnStChild, styles.tyChnStChildBg]} />
