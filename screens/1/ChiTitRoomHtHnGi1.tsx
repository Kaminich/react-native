...
const ChiTitRoomHtHnGi1 = () => {
  return (
    <View style={[styles.chiTitRoomHtHnGi, styles.composerBg]}>
      <View style={styles.roomheaderParent}>
          ...
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              ...
              <View style={[styles.logMessagenormal, styles.logFlexBox]}>
                ...
                <Text style={[styles.honTtCuc, styles.htThiHnTypo]}>
              ...
              <View style={[styles.messageitem1, styles.messageitemLayout]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  ...
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.htThiHnTypo]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            ...
            />
            <Text style={[styles.htThiHn, styles.htThiHnTypo]}>
...
export default ChiTitRoomHtHnGi1;
