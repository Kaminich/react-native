...
const ChNhChatViewNgiMtR = () => {
  return (
    <View style={[styles.chNhChatViewNgiMtR, styles.chatBg]}>
          ...
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={styles.messagecellFlexBox}>
              ...
              <View style={styles.logFlexBox}>
                ...
                <Text
                  style={[styles.chNhChat, styles.honTtCucLayout]}
            ...
            <View style={styles.messagecellFlexBox}>
              ...
              <View style={styles.logFlexBox}>
                ...
                <Text style={[styles.huongnt2564, styles.huongntTypo]}>
                  HuongNT256
                </Text>
              </View>
            </View>
        ...
        <View style={styles.composeBar}>
          <View style={[styles.helperText, styles.helperTextSpaceBlock]}>
            <Text style={[styles.description, styles.honTtCucLayout]}>
              <Text style={styles.halt82}>HaLT82</Text>
              <Text style={styles.chNhChat2}>
                {" "}
                đã chỉ định chat cho người khác. Bạn không thể tiếp tục chat
              </Text>
            </Text>
          </View>
...
export default ChNhChatViewNgiMtR;
