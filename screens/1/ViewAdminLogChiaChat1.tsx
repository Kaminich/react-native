...
const ViewAdminLogChiaChat1 = () => {
  return (
    <View style={styles.viewAdminLogChiaChat}>
      ...
      <View style={styles.viewAdminLogChiaChatChild} />
...
export default ViewAdminLogChiaChat1;
