...
const ReplyGridHnhNh = () => {
  return (
    <View style={[styles.replyGridHnhNh, styles.imgIcon2Layout]}>
            ...
            <View style={[styles.messagecell, styles.messagecellFlexBox]}>
              <View style={styles.avtFlexBox}>
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../../assets/avt12.png")}
                />
              </View>
                ...
                <View style={styles.messageTypeimageGroup}>
                  ...
                  <View style={styles.messageTypeimage1}>
                    <Image
                      style={styles.imgIcon}
                      resizeMode="cover"
                      source={require("../../assets/img25.png")}
                    />
                  </View>
                </View>
              </View>
              ...
              <View style={styles.messageitemFlexBox}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  ...
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.angTrLiTypo]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
                  ...
                  <View style={styles.replyMessageWrapper}>
                    ...
                    >
                      <View style={styles.replyType}>
                        <View style={styles.messageTypeimageGroup1}>
                          <View style={styles.messageTypeimage2}>
                            <Image
                              style={[styles.imgIcon2, styles.imgIcon2Layout]}
                              resizeMode="cover"
                              source={require("../../assets/img29.png")}
                            />
                          </View>
                          <View style={styles.messageTypeimage3}>
                            <Image
                              style={[styles.imgIcon2, styles.imgIcon2Layout]}
                              resizeMode="cover"
                              source={require("../../assets/img29.png")}
