...
const ChiTitRoomChaNhpTextC1 = () => {
  return (
    <View style={styles.chiTitRoomChaNhpTextC}>
        ...
        <View style={styles.composeBar}>
          ...
          <View style={styles.chooseImage}>
            ...
            <View style={[styles.button, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text2, styles.textTypo]}>Gửi 2</Text>
              <Image
...
export default ChiTitRoomChaNhpTextC1;
