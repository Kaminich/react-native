...
const ChNhChat = () => {
  return (
    <View style={styles.chNhChat}>
      ...
      <View style={styles.chNhChatChild} />
        ...
        <View style={styles.listAgent}>
          <View style={[styles.fieldinputParent, styles.roomheaderSpaceBlock]}>
            <View style={[styles.fieldinput, styles.buttonFlexBox1]}>
              ...
              />
              <View style={styles.returnVisitorParent}>
                <Text style={[styles.text2, styles.kTypo]}>
          ...
          <View style={styles.listAgent1}>
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>Tôi (HaDT53)</Text>
            ...
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>HaLT82</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>HiepNH21</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>HuongNT256</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>MinhPD11</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>NguyetNB2</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>NhungVTH15</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>QuanDV17</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>QuangDD16</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              />
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>SangTT9</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>ThucPT3</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>TriLM22</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
            ...
            <View style={styles.dropdownitem}>
              ...
              <View style={styles.nameSecondLine}>
                <Text style={[styles.name2, styles.kTypo]}>VanNT99</Text>
                <Text style={[styles.text4, styles.labelTypo]}>
                  Second line
                </Text>
              </View>
        ...
        <View style={styles.actionSheetfooter}>
          <View style={styles.buttonParent}>
            <View style={[styles.button1, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text17, styles.textTypo]}>Secondary</Text>
              <Image
            ...
            <View style={[styles.button2, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text18, styles.textTypo]}>Xác nhận</Text>
              <Image
                style={[styles.iconsetplaceholder3, styles.leftIconLayout]}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder6.png")}
