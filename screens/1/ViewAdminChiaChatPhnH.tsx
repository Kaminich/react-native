...
const ViewAdminChiaChatPhnH = () => {
  return (
    <View style={styles.viewAdminChiaChatPhnH}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={[styles.khungChat, styles.khungChatFlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={[styles.messagelogAction2, styles.messagecellFlexBox]}>
              <Text style={[styles.time, styles.timeClr]}>12:05</Text>
              <View style={styles.logFlexBox}>
                <Text style={[styles.bn, styles.huongntTypo]}>Bạn</Text>
                <Text
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.honTtCucLayout]}>
              <Text style={[styles.huongnt2565, styles.huongntTypo1]}>
                HuongNT256
              </Text>
...
export default ViewAdminChiaChatPhnH;
