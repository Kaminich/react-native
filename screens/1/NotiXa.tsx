  ...
  return (
    <View style={styles.notixa}>
      <View style={[styles.noti, styles.notiPosition]}>
        ...
        <View style={[styles.notiInApp, styles.title2Position]}>
          ...
          <View style={styles.nguynKhnhHuynBnhLuParent}>
            ...
            <View style={styles.time}>
              <Text style={[styles.viGiyTrc, styles.trcTypo]}>
                vài giây trước
              </Text>
            </View>
          </View>
        ...
        <View style={[styles.notiInApp8, styles.notiSpaceBlock1]}>
          <Image
            style={styles.notiIcon}
            resizeMode="cover"
            source={require("../../assets/notiicon.png")}
        ...
        <View style={[styles.notiInApp9, styles.notiSpaceBlock]}>
          ...
          <View style={styles.nguynKhnhHuynBnhLuParent}>
            ...
            <View style={styles.time}>
              <Text style={[styles.tingTrc2, styles.trcTypo]}>
                3 tiếng trước
              </Text>
            </View>
          </View>
      ...
      <View style={[styles.notiLine, styles.notiSpaceBlock1]}>
        ...
        <View style={styles.nguynKhnhHuynBnhLuParent}>
          ...
          <Text style={styles.phtTrc4}>Thứ Tư, ngày 12/04 15:11</Text>
        </View>
      </View>
      <View style={[styles.notiLine1, styles.notiSpaceBlock1]}>
        ...
        <View style={styles.nguynKhnhHuynBnhLuParent}>
          ...
          <Text style={styles.phtTrc4}>Thứ Tư, ngày 12/04 15:23</Text>
        </View>
      </View>
      <View style={[styles.notiLine2, styles.notiSpaceBlock1]}>
        ...
        <View style={styles.nguynKhnhHuynBnhLuParent}>
          ...
          <Text style={styles.phtTrc4}>Thứ Tư, ngày 12/04 17:00</Text>
        </View>
      </View>
      <View style={[styles.notiLine3, styles.notiSpaceBlock1]}>
        ...
        <View style={styles.nguynKhnhHuynBnhLuParent}>
          ...
          <Text style={styles.phtTrc4}>Thứ Năm, ngày 13/04 11:12</Text>
        </View>
      </View>
      <View style={[styles.notiLine4, styles.notiSpaceBlock1]}>
        ...
        <View style={styles.nguynKhnhHuynBnhLuParent}>
          ...
          <Text style={styles.phtTrc4}>Thứ Bảy, ngày 25/03 12:31</Text>
        </View>
      </View>
      ...
      <View style={[styles.notiLine6, styles.notiSpaceBlock1]}>
        ...
        <View style={styles.nguynKhnhHuynBnhLuParent}>
          ...
          <Text style={styles.phtTrc4}>5 phút trước</Text>
        </View>
      </View>
        ...
        <View style={styles.tabBarParent}>
          <View style={styles.tabBar1}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/menu-icon31.png")}
            />
          ...
          <View style={styles.tabParent}>
            <View style={[styles.tab, styles.tabFlexBox]}>
              ...
              <View style={styles.badgeSpaceBlock}>
                <Text style={[styles.number, styles.trcTypo]}>16</Text>
              </View>
            </View>
            <View style={styles.tabFlexBox}>
              <Image
                ...
                source={require("../../assets/social22.png")}
              />
              <Text style={[styles.label8, styles.labelTypo]}>Chưa đọc</Text>
              <View style={[styles.badge1, styles.badgeSpaceBlock]}>
                <Text style={[styles.number, styles.trcTypo]}>1</Text>
              </View>
            </View>
            <View style={styles.tabFlexBox}>
              <Image
                ...
                source={require("../../assets/social22.png")}
              />
              <Text style={[styles.label8, styles.labelTypo]}>{`Đã đọc `}</Text>
              <View style={styles.badgeSpaceBlock}>
                <Text style={[styles.number, styles.trcTypo]}>16</Text>
              </View>
            </View>
