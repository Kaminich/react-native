...
const ChiTitRoomChn1FileIos2 = () => {
  return (
    <View style={styles.chiTitRoomChn1FileIos}>
      <View style={[styles.roomheaderParent, styles.parentLayout]}>
        ...
        <View style={styles.composerdefaultFlexBox}>
          ...
          <View style={styles.chooseImage}>
            ...
            <View style={[styles.homeindicator1, styles.image17IconPosition]}>
      ...
      <View
        style={[styles.chiTitRoomChn1FileIosChild, styles.homeIndicator1Bg]}
      />
      <Image
...
export default ChiTitRoomChn1FileIos2;
