...
const TruyCpCameraTHLoginKC = () => {
  return (
    <View style={styles.truyCpCameraThLoginKC}>
      <View
      ...
      <Image
        style={[
          styles.truyCpCameraThLoginKCChild,
          ...
          <View style={styles.content}>
            ...
            <View style={styles.titleParent}>
              ...
              <Text style={[styles.text16, styles.label8Clr]}>
                Sale Online Platform cần có quyền sử dụng Camera để chụp ảnh
              </Text>
            </View>
          </View>
...
export default TruyCpCameraTHLoginKC;
