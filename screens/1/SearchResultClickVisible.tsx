...
const SearchResultClickVisible = () => {
  return (
    <View style={[styles.searchResultClickVisible, styles.composerBg]}>
...
const styles = StyleSheet.create({
  ...
  searchResultClickVisible: {
    width: "100%",
    height: 681,
  },
});

export default SearchResultClickVisible;
