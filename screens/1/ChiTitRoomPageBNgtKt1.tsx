...
const ChiTitRoomPageBNgtKt1 = () => {
  return (
    <View style={styles.chiTitRoomPageBNgtKt}>
        ...
        <View style={styles.composeBar}>
          <View style={[styles.helperText, styles.roomheaderFlexBox]}>
            <Text style={[styles.trangFptCameraContainer, styles.label7Clr]}>
              ...
              <Text style={styles.trang}> đã bị ngắt kết nối.</Text>
            </Text>
          </View>
      ...
      <View
        style={[styles.chiTitRoomPageBNgtKtChild, styles.homeIndicatorBg]}
      />
...
export default ChiTitRoomPageBNgtKt1;
