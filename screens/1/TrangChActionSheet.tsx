...
`}</Text>
      ...
      <Image
        style={styles.trangChActionSheetChild}
        resizeMode="cover"
      ...
      <View style={[styles.actionSheetst, styles.actionSheetstPosition]}>
        <View style={[styles.actionSheetlistCell, styles.actionSpaceBlock]}>
          <Image
            style={[styles.calendarIcon, styles.iconLayout]}
            resizeMode="cover"
            source={require("../../assets/18-account.png")}
          />
          <View style={styles.labelParent}>
            ...
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={[styles.illustration, styles.menuIcon3Position]} />
            </View>
          </View>
        </View>
        ...
        <View style={[styles.actionSheetlistCell2, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label8, styles.labelLayout]}>Sao chép số</Text>
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={[styles.illustration, styles.menuIcon3Position]} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell3, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label11, styles.labelLayout]}>Đăng xuất</Text>
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={[styles.illustration, styles.menuIcon3Position]} />
            </View>
          </View>
...
export default TrangChActionSheet;
