...
const LogNhChatViewNgiNhn = () => {
  return (
    <View style={styles.logNhChatViewNgiNhn}>
      ...
      <View style={styles.logNhChatViewNgiNhnChild} />
          ...
          <View style={styles.activityFeed}>
            <View style={styles.activityFeedLog}>
              <Image
                ...
                resizeMode="cover"
                source={require("../../assets/frame-42731876726.png")}
              />
              <View style={styles.nameParent}>
...
export default LogNhChatViewNgiNhn;
