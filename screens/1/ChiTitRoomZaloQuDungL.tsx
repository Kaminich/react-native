...
const ChiTitRoomZaloQuDungL = () => {
  return (
    <View style={styles.chiTitRoomZaloQuDungL}>
      ...
      <View
        style={[styles.chiTitRoomZaloQuDungLChild, styles.homeIndicatorBg]}
      />
          ...
          <View style={styles.messagelogAction}>
            ...
            <View style={styles.titleParent}>
              ...
              <Text style={[styles.text2, styles.bnLayout]}>
                Zalo hỗ trợ định dạng: doc, docx, pdf, với dung lượng tối đa
                5MB, jpg, png, heif, heic, jpeg, tiff, tif, webp, gif với dung
                lượng tối đa là 1MB
              </Text>
            </View>
          </View>
...
export default ChiTitRoomZaloQuDungL;
