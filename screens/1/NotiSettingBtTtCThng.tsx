...
const NotiSettingBtTtCThng = () => {
  return (
    <View style={styles.notisettingbtTtCThng}>
      ...
      <View style={[styles.notiLine4, styles.notiSpaceBlock]}>
        <Image
          style={styles.notiIcon}
          resizeMode="cover"
          source={require("../../assets/notiicon25.png")}
        />
        <View style={styles.nguynKhnhHuynBnhLuParent}>
          <Text style={styles.nguynKhnhHuynContainer12}>
      ...
      <View
        style={[styles.notisettingbtTtCThngChild, styles.notisettingPosition]}
      />
              ...
              <View style={styles.frameContainer}>
                <View style={styles.componentSettingNotiParent}>
                  ...
                  >
                    ...
                    <View style={[styles.switch2, styles.switch2SpaceBlock]}>
                      <View
                        style={[
                  ...
                  >
                    ...
                    <View style={[styles.switch4, styles.switchLayout]}>
                      <View
                        style={[
...
export default NotiSettingBtTtCThng;
