      ...
      <View style={styles.roomheaderParent}>
            ...
            <View style={styles.nameParent}>
              <View style={styles.name}>
                ...
                <View style={styles.returnVisitorParent}>
                  <Image
                    style={[styles.returnVisitorIcon, styles.icon20x20Layout]}
                    resizeMode="cover"
                    source={require("../../assets/return-visitor1.png")}
                  />
                  <Text style={[styles.lMinhTr, styles.label7Layout]}>
                    Lê Minh Trí
                  </Text>
                  <Image
                    style={[
        ...
        <View style={styles.composeBar}>
          ...
          <View style={styles.composeBar1}>
            ...
            <View style={[styles.composer, styles.composerBorder]}>
              <View style={styles.niDungTinNhn1DngWrapper}>
                <Text style={[styles.niDungTin, styles.label7Layout]}>
                  Chào bạn
                </Text>
              </View>
              <Image
          ...
          <View style={styles.actionSheetcomposer}>
            <View
              style={[styles.actionSheetlistCell, styles.khungChatSpaceBlock]}
            >
              <Image
                style={[styles.iconsendPlaneFill, styles.icon20x20Layout]}
                resizeMode="cover"
              ...
              <View style={styles.labelParent}>
                <Text style={[styles.label7, styles.label7Layout]}>
                  Thư viện ảnh
                </Text>
            ...
            >
              ...
              />
              <View style={styles.labelParent}>
                <Text style={[styles.label7, styles.label7Layout]}>Camera</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
            ...
            >
              ...
              />
              <View style={styles.labelParent}>
                <Text style={[styles.label7, styles.label7Layout]}>GIF</Text>
                <View style={[styles.icon20x20, styles.icon20x20Layout]}>
                  <View style={styles.illustration} />
                </View>
              </View>
...
export default ChiTitRoomTypingAdd2;
