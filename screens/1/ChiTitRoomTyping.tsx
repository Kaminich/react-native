...
const ChiTitRoomTyping = () => {
  return (
    <View style={styles.chiTitRoomTyping}>
          ...
          <View style={[styles.composeBar1, styles.khungChatFlexBox]}>
            ...
            <View style={[styles.composer, styles.composerFlexBox]}>
              <View style={styles.niDungTinNhn1DngWrapper}>
                <Text style={styles.niDungTinContainer}>
                  <Text style={styles.choBn}>Chào bạn</Text>
...
export default ChiTitRoomTyping;
