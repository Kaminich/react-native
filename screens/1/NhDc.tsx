...
const NhDc = () => {
  return (
    <View style={styles.nhDc}>
      <View style={[styles.roomheaderParent, styles.nhDcChildPosition]}>
      ...
      <View style={[styles.nhDcChild, styles.nhDcChildLayout]} />
      <Image
        style={[styles.image1Icon, styles.nhDcChildLayout]}
        resizeMode="cover"
