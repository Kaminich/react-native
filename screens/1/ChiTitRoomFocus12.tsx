            ...
            <View style={[styles.messagecell1, styles.messagecellFlexBox]}>
              <View style={[styles.messageitem5, styles.messageitemLayout]}>
                <View>
                  ...
                  <View
                    style={[
                      styles.messageTypeimageGroup1,
                      styles.messageSpaceBlock,
                    ]}
                  >
                    <View style={styles.messageTypeimage}>
                      <Image
                    ...
                    <View style={styles.messageTypeimage1}>
                      <Image
                        style={styles.imgIcon}
                        resizeMode="cover"
                        source={require("../../assets/img18.png")}
                      />
                    </View>
                  </View>
                  <View style={styles.messageSpaceBlock}>
                    <Image
                      style={styles.imgIcon}
                      resizeMode="cover"
                      source={require("../../assets/img19.png")}
                    />
                  </View>
                </View>
              </View>
...
export default ChiTitRoomFocus12;
