...
const ViewAdminChiaLiChatPh = () => {
  return (
    <View style={styles.viewAdminChiaLiChatPh}>
      <View style={styles.roomheaderParent}>
          ...
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={styles.messagecellFlexBox}>
              ...
              <View style={styles.logFlexBox}>
                <Text style={[styles.bn, styles.huongntTypo]}>Bạn</Text>
                <Text
                  style={[styles.chiaChatCho, styles.honTtCucLayout]}
            ...
            <View style={[styles.messagecell, styles.messagecellFlexBox]}>
              <View style={styles.avtFlexBox}>
                <View style={[styles.avt2, styles.avtLayout]}>
                  <Text style={[styles.k, styles.huongntTypo]}>H</Text>
                </View>
              </View>
              <View style={styles.huongnt256Parent}>
                ...
                <View style={styles.messagevertical}>
                  <View style={[styles.messageitem1, styles.messageitemBg]}>
                    <View
            ...
            <View style={styles.messagecellFlexBox}>
              <Text style={[styles.time, styles.timeClr]}>13:05</Text>
              <View style={styles.logFlexBox}>
                <Text style={[styles.bn, styles.huongntTypo]}>Bạn</Text>
                <Text
                  style={[styles.chiaChatCho, styles.honTtCucLayout]}
            ...
            <View style={[styles.messagecell, styles.messagecellFlexBox]}>
              ...
              <View style={styles.huongnt256Parent}>
                ...
                <View style={[styles.messageitem4, styles.messageitemBg]}>
            ...
            <View style={[styles.messagecell3, styles.messagecellFlexBox]}>
              <View style={[styles.messageitem5, styles.messageitemBg]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  <Image
                    style={styles.returnVisitorIconLayout}
                    resizeMode="cover"
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.honTtCucLayout]}>
              <Text style={[styles.halt82, styles.huongntTypo1]}>HaLT82</Text>
...
export default ViewAdminChiaLiChatPh;
