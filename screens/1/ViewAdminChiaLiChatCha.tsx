...
const ViewAdminChiaLiChatCha = () => {
  return (
    <View style={styles.viewAdminChiaLiChatCha}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={[styles.khungChat, styles.khungChatFlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={[styles.messagecell2, styles.messagecellFlexBox]}>
              <View style={styles.avtFlexBox}>
                <Image
                  style={styles.avtLayout}
                  resizeMode="cover"
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.honTtCucLayout]}>
              <Text style={[styles.huongnt2566, styles.huongntTypo1]}>
                HuongNT256
              </Text>
...
export default ViewAdminChiaLiChatCha;
