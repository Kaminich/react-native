...
const ReplyTinNhnParagraph = () => {
  return (
    <View style={[styles.replyTinNhnParagraph, styles.composerBg]}>
                    ...
                    >
                      <View style={styles.replyType}>
                        <Text
                          ...
                          numberOfLines={1}
                        >
                          Tôi muốn tìm hiểu về sản phẩm dịch vụ bên bạn, vui
...
const styles = StyleSheet.create({
  ...
  replyTinNhnParagraph: {
    width: "100%",
    height: 681,
  },
});

export default ReplyTinNhnParagraph;
