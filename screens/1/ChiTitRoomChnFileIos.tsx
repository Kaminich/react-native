...
const ChiTitRoomChnFileIos = () => {
  return (
    <View style={styles.chiTitRoomChnFileIos}>
      ...
      <View
        style={[styles.chiTitRoomChnFileIosChild, styles.homeIndicator1Bg]}
      />
      <Image
...
export default ChiTitRoomChnFileIos;
