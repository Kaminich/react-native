      ...
      <View style={styles.roomheaderParent}>
          ...
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={[styles.messagecell1, styles.messagecellFlexBox]}>
              <View style={styles.messageitem1}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../../assets/attachment--filetypes7.png")}
                  />
                  <View style={styles.fileName}>
                    <Text
                      style={[styles.fileDinhKemdoc, styles.okeTypo]}
                      numberOfLines={1}
                    >
                      file_dinh_kem.doc
                    </Text>
              ...
              <View style={[styles.status, styles.avtFlexBox1]}>
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../../assets/messagestatus4.png")}
                />
              </View>
            </View>
            <View style={[styles.messagelogAction, styles.messagecellFlexBox]}>
              ...
              <View style={styles.logMessagenormal}>
                ...
                <Text style={[styles.honTtCuc, styles.okeTypo]}>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.okeTypo]}>
        ...
        <View style={[styles.button, styles.buttonBorder]}>
          <View style={[styles.badge, styles.redFlexBox]}>
            <Text style={[styles.number, styles.timeTypo]}>12</Text>
          </View>
          <Text style={[styles.text, styles.textTypo]}>Button field</Text>
          <Image
            style={[styles.doubleDownIcon, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../../assets/double-down3.png")}
          />
        </View>
...
export default SearchDetailInvisible2;
