        ...
        <View style={styles.contentParent}>
          <View style={styles.messagelogAction}>
            ...
            <View style={styles.titleParent}>
              <Text style={styles.title}>Hội thoại Zalo</Text>
              <Text style={[styles.text1, styles.bnLayout]}>
                <Text
                  style={styles.oaKhngTh}
                >{`OA không thể gửi tin Tư vấn cho Người dùng không phát sinh tương tác với OA trong vòng 7 ngày gần nhất. `}</Text>
                <Text style={[styles.xemChiTit, styles.bnTypo]}>
                  Xem chi tiết
                </Text>
              </Text>
            </View>
...
export default ChiTitRoomHtHnGiXem1;
