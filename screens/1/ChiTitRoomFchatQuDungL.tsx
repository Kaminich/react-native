...
const ChiTitRoomFchatQuDungL = () => {
  return (
    <View style={styles.chiTitRoomFchatQuDungL}>
          ...
          <View style={styles.room}>
            <View style={styles.roommessageavt}>
              <View style={styles.avt}>
                <Text style={[styles.k, styles.kTypo]}>LT</Text>
              </View>
              <Image
                style={styles.socialIcon}
                resizeMode="cover"
                source={require("../../assets/social39.png")}
              />
            </View>
        ...
        <View style={[styles.khungChat, styles.khungChatFlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              <Text style={[styles.time, styles.kTypo]}>12:05</Text>
              ...
              <View style={[styles.messageitem1, styles.button1Bg]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../../assets/attachment--filetypes6.png")}
                  />
      ...
      <View
        style={[styles.chiTitRoomFchatQuDungLChild, styles.homeIndicatorBg]}
      />
          ...
          <View style={styles.messagelogAction}>
            ...
            <View style={styles.titleParent}>
              ...
              <Text style={[styles.text2, styles.bnLayout]}>
                Fchat hỗ trợ định dạng: doc, docx, xlsx, xls, ppt, pptx, pdf,
                jpg, png, heif, heic, jpeg, tiff, tif, webp, gif, mp3, mp4, wav,
                m4a, wma, flac, zip, rar với dung lượng tối đa 25MB
              </Text>
            </View>
          </View>
...
export default ChiTitRoomFchatQuDungL;
