...
const ChiTitRoomviewAdmin = () => {
  return (
    <View style={[styles.chiTitRoomviewAdmin, styles.composerBg]}>
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.honTtCucLayout]}>
              ...
              <Text style={styles.huongnt2563}>HuongNT256</Text>
...
export default ChiTitRoomviewAdmin;
