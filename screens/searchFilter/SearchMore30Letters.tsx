...
const SearchMore30Letters = () => {
  return (
    <View style={styles.searchQu30KT}>
      <View style={styles.statusbarIphone13Parent}>
        ...
        <View style={[styles.searchsearch, styles.buttonSpaceBlock]}>
          <View style={styles.fieldinputParent}>
            <View style={[styles.fieldinput, styles.fieldinputLayout]}>
              <Image
              ...
              <View style={styles.textWapper}>
                <Text style={[styles.text1, styles.textTypo1]}>
                  tìm kiếm khi nhập quá 30 ký tự
                </Text>
          ...
          <Text style={[styles.error, styles.nameTypo]}>
            Tìm kiếm vượt quá 30 kí tự
          </Text>
        </View>
        <View>
          <View>
            ...
            <View style={styles.actionSheetempty}>
              <View style={[styles.search, styles.searchSpaceBlock]}>
                <View style={[styles.fieldinput1, styles.fieldinputLayout]}>
                  <Image
                    style={[styles.searchIcon, styles.iconLayout]}
                    resizeMode="cover"
                    source={require("../../assets/1-search2.png")}
              ...
              <View style={[styles.emptyCard, styles.searchSpaceBlock]}>
                ...
                <View style={[styles.button, styles.text3SpaceBlock]}>
                  ...
                  />
                  <Text style={styles.text4}>Button field</Text>
                  <Image
                    style={[
            ...
            >
              <View style={styles.roommessageavtWrapper}>
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../../assets/roommessageavt31.png")}
                />
              </View>
            ...
            >
              <View style={styles.roommessageavtWrapper}>
                <Image
                  style={styles.roommessageavtIcon}
                  resizeMode="cover"
                  source={require("../../assets/roommessageavt32.png")}
                />
              </View>
              <View style={styles.nameSecondLine}>
            ...
            >
              <View style={styles.roommessageavtWrapper}>
                <Image
                  style={styles.roommessageavtIcon}
                  resizeMode="cover"
                  source={require("../../assets/roommessageavt33.png")}
                />
              </View>
              <View style={styles.nameSecondLine}>
            ...
            >
              <View style={styles.roommessageavtWrapper}>
                <Image
                  style={styles.roommessageavtIcon}
                  resizeMode="cover"
                  source={require("../../assets/roommessageavt34.png")}
                />
              </View>
              <View style={styles.nameSecondLine}>
            ...
            >
              <View style={styles.roommessageavtWrapper}>
                <Image
                  style={styles.roommessageavtIcon}
                  resizeMode="cover"
                  source={require("../../assets/roommessageavt36.png")}
                />
              </View>
              <View style={styles.nameSecondLine}>
            ...
            >
              <View style={styles.roommessageavtWrapper}>
                <Image
                  style={styles.roommessageavtIcon}
                  resizeMode="cover"
                  source={require("../../assets/roommessageavt37.png")}
                />
              </View>
              <View style={styles.nameSecondLine}>
            ...
            >
              <View style={styles.roommessageavtWrapper}>
                <Image
                  style={styles.roommessageavtIcon}
                  resizeMode="cover"
                  source={require("../../assets/roommessageavt38.png")}
                />
              </View>
              <View style={styles.nameSecondLine}>
            ...
            <View style={styles.bottomRow}>
              <View style={styles.keys1}>
                <View style={styles.key19}>
                  <View
                    style={[
                      styles.keycontainer19,
                      styles.keycontainerShadowBox,
                    ]}
                  />
...
export default SearchMore30Letters;
