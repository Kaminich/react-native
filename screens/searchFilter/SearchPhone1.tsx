  ...
  return (
    <View style={styles.searchSt}>
      <View style={styles.statusbarIphone13Parent}>
        ...
        <View style={[styles.searchsearch, styles.dropdownsearchSpaceBlock]}>
          <View style={[styles.fieldinputParent, styles.titleParentFlexBox]}>
            <View style={[styles.fieldinput, styles.fieldinputFlexBox]}>
              ...
              />
              <View style={[styles.textWapper, styles.titleParentFlexBox]}>
                <Text style={[styles.text1, styles.nameClr]}>0348569871</Text>
        ...
        <View style={styles.section1Parent}>
          <View>
            <View style={[styles.titleParent, styles.titleParentFlexBox]}>
              ...
              <Text style={[styles.xemThm, styles.nameLayout]}>Xem thêm</Text>
            </View>
            <View
              style={[
                styles.dropdownsearchRoomResult,
                styles.dropdownsearchSpaceBlock,
              ]}
            >
              ...
              <View style={styles.nameSecondLine}>
                ...
                <View style={[styles.page, styles.titleParentFlexBox]}>
                  ...
                  />
                  <Text style={[styles.sccService, styles.text2Typo]}>
                    Lắp đặt Camera FPT
                  </Text>
                </View>
                <Text style={[styles.text2, styles.text2Typo]}>0348569871</Text>
              </View>
            </View>
            <View
              style={[
            ...
            <View
              style={[
                styles.dropdownsearchRoomResult3,
                styles.dropdownsearchSpaceBlock,
              ]}
            >
              <View style={styles.fieldinputFlexBox}>
