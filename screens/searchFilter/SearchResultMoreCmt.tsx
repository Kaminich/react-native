...
const SearchResultMoreCmt = () => {
  return (
    <View style={styles.searchResultXemThmBnhLu}>
        ...
        <View style={[styles.searchRoom, styles.leftIconPosition]}>
          ...
          >
            ...
            <View style={styles.nameSecondLine}>
              <Text style={[styles.name, styles.nameTypo]}>Phạm Đức Khôi</Text>
          ...
          >
            ...
            <View style={styles.nameSecondLine}>
              <Text style={[styles.name, styles.nameTypo]}>Nguyễn Thị Vân</Text>
              <View style={[styles.page, styles.pageSpaceBlock]}>
                <Image
                  style={styles.iconright}
                  resizeMode="cover"
          ...
          >
            ...
            <View style={styles.nameSecondLine}>
              <Text style={[styles.name, styles.nameTypo]}>Mai Thu An</Text>
              <View style={[styles.page, styles.pageSpaceBlock]}>
                <Image
                  style={styles.iconright}
                  resizeMode="cover"
          ...
          >
            ...
            <View style={styles.nameSecondLine}>
              <Text style={[styles.name, styles.nameTypo]}>Nguyễn Văn Nam</Text>
              <View style={[styles.page, styles.pageSpaceBlock]}>
                <Image
                  style={styles.iconright}
                  resizeMode="cover"
...
export default SearchResultMoreCmt;
