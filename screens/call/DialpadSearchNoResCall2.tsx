...
const DialpadSearchNoResCall2 = () => {
  return (
    <View style={styles.dialpadSearchNoResCall}>
      ...
      <View
        style={[
          styles.dialpadSearchNoResCallChild,
          styles.headerParentPosition,
        ]}
      />
...
export default DialpadSearchNoResCall2;
