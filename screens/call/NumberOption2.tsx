...
const NumberOption2 = () => {
  return (
    <View style={styles.numberOption}>
      <View style={styles.roomheaderParent}>
        <View style={[styles.roomheader, styles.roomheaderSpaceBlock]}>
          ...
          <View style={styles.room}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/roommessageavt41.png")}
            />
          ...
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={[styles.messagecell1, styles.messagecellFlexBox]}>
              <View style={[styles.messageitem1, styles.messageitemLayout]}>
                <View style={[styles.messageTypetext, styles.messageFlexBox]}>
                  <Text style={[styles.tiCnH1, styles.tiCnHTypo]}>
                    Vui lòng để lại số điện thoại, chúng tôi sẽ gọi điện tư vấn
                    ngay đến anh/chị!
                  </Text>
                </View>
              </View>
            ...
            <View style={[styles.messagecell, styles.messagecellFlexBox]}>
              ...
              <View style={[styles.messageitem, styles.messageitemLayout]}>
                <View style={[styles.messageTypetext, styles.messageFlexBox]}>
                  <Text style={[styles.tiCnH4, styles.tiCnHTypo]}>
                    0331974521
                  </Text>
                </View>
              </View>
            ...
            <View style={[styles.messagecell5, styles.messagecellFlexBox]}>
              <View style={[styles.messageitem1, styles.messageitemLayout]}>
                <View style={[styles.messageTypefile, styles.messageFlexBox]}>
                  <Image
                    style={[styles.attachmentFiletypes, styles.iconLayout]}
                    resizeMode="cover"
        ...
        <View style={styles.composeBar}>
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.numberOptionChildBg]} />
          </View>
        </View>
      </View>
      ...
      <View style={[styles.numberOptionChild, styles.numberOptionChildBg]} />
      <View style={[styles.actionSheetst, styles.actionSheetstPosition]}>
        <View style={[styles.actionSheetlistCell, styles.actionSpaceBlock]}>
          <Image
            style={[styles.callConnectingIcon, styles.iconLayout]}
            resizeMode="cover"
            source={require("../../assets/call-connecting.png")}
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label7, styles.labelTypo]}>Gọi điện</Text>
        ...
        <View style={[styles.actionSheetlistCell1, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label7, styles.labelTypo]}>Mở hộp thư</Text>
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.actionSheetlistCell2, styles.actionSpaceBlock]}>
          ...
          />
          <View style={styles.labelParent}>
            <Text style={[styles.label7, styles.labelTypo]}>Sao chép số</Text>
            <View style={[styles.icon20x20, styles.iconLayout]}>
              <View style={styles.illustration} />
            </View>
          </View>
        ...
        <View style={[styles.homeindicator1, styles.actionSheetstPosition]}>
          <View style={[styles.homeIndicator, styles.numberOptionChildBg]} />
        </View>
      </View>
    </View>
