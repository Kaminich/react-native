...
const AcceptCallLoudSpeaker2 = () => {
  return (
    <View style={styles.acceptCallLoudSpeaker}>
        ...
        <View style={styles.bottom}>
          ...
          <View style={[styles.iconContainerParent, styles.optionFlexBox]}>
            ...
            <Image
              style={styles.iconContainer}
              resizeMode="cover"
              source={require("../../assets/icon-container19.png")}
            />
            <Image
              style={styles.iconContainer}
              resizeMode="cover"
...
export default AcceptCallLoudSpeaker2;
