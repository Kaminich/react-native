...
import { IncomingMinimize } from "../components/CallMinimize2";

const IncomingCallMinimize2 = () => {
  return (
    <View style={styles.incomingCallMinimize}>
...
export default IncomingCallMinimize2;
