...
const AcceptCallFullScreenMute2 = () => {
  return (
    <View style={styles.acceptCallFullScreenMute}>
        ...
        <View style={styles.bottom}>
          ...
          <View style={[styles.iconContainerParent, styles.optionFlexBox]}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/icon-container18.png")}
            />
            <Image
              style={styles.iconContainer}
              resizeMode="cover"
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.optionPosition]} />
          </View>
        </View>
      </View>
    </View>
...
export default AcceptCallFullScreenMute2;
