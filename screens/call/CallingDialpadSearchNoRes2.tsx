...
const CallingDialpadSearchNoRes2 = () => {
  return (
    <View style={styles.callingDialpadSearchNoRes}>
        ...
        <View style={[styles.body, styles.avtFlexBox]}>
          ...
          <View style={styles.name}>
            <View style={styles.name1}>
              <Text style={[styles.name2, styles.kFlexBox]}>0336174912</Text>
...
export default CallingDialpadSearchNoRes2;
