...
const DialpadSearchCalls2 = () => {
  return (
    <View style={styles.dialpadSearchCalls}>
      ...
      <View
        style={[styles.dialpadSearchCallsChild, styles.headerParentPosition]}
      />
...
export default DialpadSearchCalls2;
