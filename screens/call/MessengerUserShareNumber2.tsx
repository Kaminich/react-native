...
const MessengerUserShareNumber2 = () => {
  return (
    <View style={[styles.messengerUserShareNumber, styles.composerBg]}>
...
export default MessengerUserShareNumber2;
