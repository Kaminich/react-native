...
const ListRoomConnectedEmpty = () => {
  return (
    <View style={styles.listRoomConnectedEmpty}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.tabControl}>
              ...
              <View style={[styles.tab4, styles.tabBorder]}>
                ...
                />
                <Text style={[styles.label4, styles.label4Typo]}>
                  Faceboook
                </Text>
                <View style={styles.badge}>
        ...
        <View style={styles.listRoom}>
          ...
          <View style={styles.roomitem}>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.lastMessage}>
                <Text
                  style={[styles.tVnGip, styles.label4Typo]}
                  numberOfLines={1}
                >
                  Tư vấn giúp mình
                </Text>
                ...
                <View style={styles.roomName}>
                  <View style={styles.page}>
                    <Image
                      ...
                      source={require("../../assets/return-visitor.png")}
                    />
                    <Text style={styles.dngKiuAnh2}>Lê Minh Trí</Text>
                    <Image
                      style={styles.statusIcon}
                      resizeMode="cover"
                      source={require("../../assets/status.png")}
          ...
          <View style={styles.roomitem}>
            <View style={styles.roommessageavtIcon}>
              ...
              <Image
                style={[styles.socialIcon6, styles.groupChildPosition]}
                resizeMode="cover"
                ...
                <View style={styles.roomName}>
                  <View style={styles.page}>
                    <Image
                      ...
                      source={require("../../assets/return-visitor.png")}
                    />
                    <Text style={styles.dngKiuAnh2}>Phạm Đức Minh</Text>
                    <Image
                      style={styles.statusIcon}
                      resizeMode="cover"
                      source={require("../../assets/status.png")}
                ...
                <View style={styles.roomName}>
                  <View style={styles.page}>
                    <Image
                      ...
                      source={require("../../assets/return-visitor.png")}
                    />
                    <Text style={styles.dngKiuAnh2}>112.34.56.391.12</Text>
                    <Image
                      style={styles.statusIcon}
                      resizeMode="cover"
                      source={require("../../assets/status.png")}
                ...
                <View style={styles.roomName}>
                  <View style={styles.page}>
                    <Image
                      ...
                      source={require("../../assets/return-visitor.png")}
                    />
                    <Text style={styles.dngKiuAnh2}>Trương Tấn Sang</Text>
                    <Image
                      style={styles.statusIcon}
                      resizeMode="cover"
                      source={require("../../assets/status.png")}
        ...
        <View style={styles.actionSheetempty}>
          <View style={[styles.search, styles.alertSpaceBlock]}>
            <View style={[styles.fieldinput, styles.groupInnerBorder]}>
              ...
              />
              <Text style={styles.text11}>Tìm kiếm</Text>
              <Image
                style={[styles.assignUserIcon, styles.iconLayout]}
                resizeMode="cover"
          ...
          <View style={styles.emptyCard}>
            <View style={[styles.illustrator, styles.avtFlexBox]}>
              <Image
                ...
                resizeMode="cover"
                source={require("../../assets/empty-state2.png")}
              />
            </View>
            <View style={[styles.text12, styles.text12SpaceBlock]}>
...
export default ListRoomConnectedEmpty;
