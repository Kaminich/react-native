          ...
          <View style={[styles.header, styles.toastShadowBox]}>
            ...
            <View style={styles.tabControl}>
              ...
              <View style={styles.tabSpaceBlock}>
                ...
                />
                <Text style={[styles.label, styles.labelSpaceBlock]}>Zalo</Text>
          ...
          <View style={[styles.pageParent, styles.pageSpaceBlock]}>
            <View style={styles.page}>
              <View style={styles.pageInner}>
                <View
                  style={[styles.rectangleParent, styles.groupInnerPosition]}
                >
                  <Image
                  ...
                  <View style={[styles.rectangleGroup, styles.groupLayout1]}>
                    ...
                    />
                    <View style={[styles.groupInner, styles.toastLayout]} />
              ...
              <View style={styles.frameParent}>
                <View style={styles.ttCTrangWrapper}>
                  <Text style={[styles.ttCTrang, styles.title2Typo]}>
                    Tất cả trang
                  </Text>
                </View>
                <Image
        ...
        <View style={styles.listRoom}>
          ...
          <View style={styles.roomitem}>
            ...
            <View style={styles.content}>
              ...
              <View style={[styles.lastMessage, styles.roomlistNhnFlexBox]}>
                <Text
                  style={[styles.hnhNh, styles.descriptionTypo]}
                  numberOfLines={1}
                >
                  [Hình ảnh]
                </Text>
          ...
          <View style={styles.roomitem}>
            ...
            <View style={styles.content}>
              ...
              <View style={[styles.lastMessage, styles.roomlistNhnFlexBox]}>
                <Text style={[styles.bn, styles.descriptionTypo]}>Bạn:</Text>
                <Image
        ...
        <View style={styles.tabBarParent}>
          ...
          <View style={styles.tabBar1}>
            <Image
              style={styles.menuIcon}
              resizeMode="cover"
              source={require("../../assets/menu-icon23.png")}
            />
...
export default ListRoomCmtFacebook3;
