...
const ListRoomCmtFacebook5 = () => {
  return (
    <View style={styles.listRoomCmtFacebook}>
      <View style={styles.header3Parent}>
        <View style={styles.header3}>
          <View style={styles.header}>
            ...
            <View style={styles.tabControlFlexBox}>
        ...
        <View style={styles.listRoom}>
          ...
          <View style={[styles.roomitemSwipe, styles.tabControlFlexBox]}>
            <View style={[styles.roomitem, styles.roomitemSpaceBlock]}>
              <Image
                style={styles.roommessageavtIcon}
                resizeMode="cover"
                source={require("../../assets/roommessageavt29.png")}
              />
            ...
            <View style={styles.buttonSwipe}>
              <View style={[styles.swipeAction, styles.swipeSpaceBlock]}>
                <Image
                  style={[styles.honTtIcon, styles.iconLayout1]}
                  resizeMode="cover"
                  source={require("../../assets/hon-tt1.png")}
                />
                <Text style={[styles.label14, styles.textTypo]}>Hoàn tất</Text>
              </View>
              <View style={[styles.swipeAction1, styles.swipeSpaceBlock]}>
                <Image
                  style={[styles.honTtIcon, styles.iconLayout1]}
                  resizeMode="cover"
                  source={require("../../assets/block-user2.png")}
                />
                <Text style={[styles.label14, styles.textTypo]}>Chặn</Text>
              </View>
            </View>
          </View>
          <View style={[styles.roomitem1, styles.roomitemSpaceBlock]}>
            <Image
              style={styles.roommessageavtIcon}
              resizeMode="cover"
          ...
          <View style={[styles.roomitem1, styles.roomitemSpaceBlock]}>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.roomlistNhn}>
                <View style={[styles.purple2, styles.purpleFlexBox]}>
                  <Text style={[styles.label7, styles.textTypo]}>KH VIP</Text>
                  <Image
                    style={[styles.closeIcon1, styles.frameChildLayout]}
                    resizeMode="cover"
                ...
                <View style={[styles.xTag2, styles.tagFlexBox]}>
                  <Text style={[styles.label7, styles.textTypo]}>+4</Text>
                  <Image
                    style={[styles.closeIcon1, styles.frameChildLayout]}
                    resizeMode="cover"
      ...
      <View style={[styles.tabBar, styles.tabBorder]}>
        ...
        <View style={styles.tabBarParent}>
          <View style={[styles.tabBar1, styles.swipeSpaceBlock]}>
            <Image
              style={styles.menuIcon}
              resizeMode="cover"
              source={require("../../assets/menu-icon14.png")}
            />
            <Text style={[styles.label58, styles.labelTypo]}>Trang chủ</Text>
          </View>
          <View style={[styles.tabBar1, styles.swipeSpaceBlock]}>
            <Image
              style={styles.menuIcon}
            ...
            />
            <Text style={[styles.label58, styles.labelTypo]}>Cuộc gọi</Text>
          </View>
          <View style={[styles.tabBar1, styles.swipeSpaceBlock]}>
            <Image
              style={styles.menuIcon}
            ...
            />
            <Text style={[styles.label60, styles.labelTypo]}>Tin nhắn</Text>
          </View>
          <View style={[styles.tabBar1, styles.swipeSpaceBlock]}>
            <Image
              style={styles.menuIcon}
            ...
            />
            <Text style={[styles.label58, styles.labelTypo]}>Thông báo</Text>
          </View>
          <View style={[styles.tabBar1, styles.swipeSpaceBlock]}>
            <Image
              style={styles.menuIcon}
            ...
            />
            <Text style={[styles.label58, styles.labelTypo]}>Khách hàng</Text>
          </View>
        </View>
...
export default ListRoomCmtFacebook5;
