...
const More10CmtSonMore = () => {
  return (
    <View style={[styles.nhiuHn10BnhLunConXem, styles.image1IconLayout]}>
            ...
            <View style={styles.commentcell}>
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                ...
                <View style={styles.actionSpaceBlock}>
                  ...
                  <View style={[styles.reacted5, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      <Image
                        style={[styles.emojiIcon, styles.iconLayout]}
                        resizeMode="cover"
                ...
                <View style={[styles.action6, styles.actionSpaceBlock]}>
                  <View style={styles.option6}>
                    <View style={styles.hyperlink}>
                      <Image
                        style={[styles.likeIcon, styles.iconLayout1]}
                        resizeMode="cover"
            ...
            <View style={styles.commentcell}>
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={styles.nameParent9}>
                  ...
                  <View
                    style={[
                      styles.commentmedia10,
                      styles.commentmediaSpaceBlock,
                    ]}
                  >
                    <Image
                      style={styles.image1Icon10}
                      resizeMode="cover"
        ...
        <View style={styles.composeBar}>
          ...
          <View style={[styles.composeBar1, styles.tree1FlexBox]}>
            ...
            <View style={[styles.composer, styles.composerFlexBox]}>
              ...
              <Image
                style={[styles.emojiIcon96, styles.emojiIcon96Position]}
                resizeMode="cover"
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.emojiIcon96Position]} />
          </View>
        </View>
      </View>
      <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text31, styles.text31Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text31Position]}
            resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  nhiuHn10BnhLunConXem: {
    height: 812,
    backgroundColor: Color.textWhite,
  },
});

export default More10CmtSonMore;
