...
const Less10CmtSon = () => {
  return (
    <View style={[styles.tHn10BnhLunCon, styles.image1IconLayout]}>
                  ...
                  <View style={[styles.reacted1, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        style={[styles.emojiIcon1, styles.emojiIconLayout]}
                        resizeMode="cover"
                        source={require("../../assets/emoji38.png")}
                      />
                      <Image
                        style={[styles.emojiIcon2, styles.emojiIconLayout]}
                        resizeMode="cover"
              ...
              <View style={styles.comment1}>
                <View style={[styles.frameView, styles.nameGroupSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.timeClr]}>15:03</Text>
                    </View>
                  </View>
                  <Text style={[styles.choMnhHi, styles.choMnhHiTypo]}>
                    Bình luận con 3
        ...
        <View style={styles.composeBar}>
          ...
          <View style={[styles.composeBar1, styles.tree1FlexBox]}>
            ...
            <View style={[styles.composer, styles.composerFlexBox]}>
              ...
              <Image
                style={[styles.emojiIcon30, styles.emojiIcon30Position]}
                resizeMode="cover"
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.emojiIcon30Position]} />
          </View>
        </View>
      </View>
      <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text10, styles.text10Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text10Position]}
            resizeMode="cover"
