...
const More10CmtSon = () => {
  return (
    <View style={[styles.nhiuHn10BnhLunCon, styles.image1IconLayout]}>
        ...
        <View style={[styles.roomheader, styles.composerFlexBox]}>
          ...
          <View style={styles.room}>
            ...
            <View style={styles.nameParent}>
              ...
              <View style={[styles.roomlistNhn, styles.commentmediaSpaceBlock]}>
          ...
          <View style={[styles.post, styles.postSpaceBlock]}>
            <View style={styles.page}>
              <Image
                ...
                resizeMode="cover"
                source={require("../../assets/rectangle-187841.png")}
              />
              <View style={styles.fptCameraParent}>
                ...
                <View style={styles.tag3}>
                  ...
                  <Image
                    style={[styles.closeIcon, styles.iconLayout1]}
                    resizeMode="cover"
                    source={require("../../assets/23-close31.png")}
                  />
                </View>
              </View>
            </View>
            <Text style={[styles.camThNtContainer, styles.xemLayout]}>
...
Càng thêm hấp dẫn
Combo `}</Text>
                <Text style={styles.xemTypo}>Internet + FPT</Text>
            ...
            <View style={styles.timerpmParent}>
              <View style={styles.timerpm}>
                <Text style={[styles.text, styles.xemLayout]}>01/06/2022</Text>
              </View>
              <View style={styles.hyperlink}>
                <Text style={[styles.xemBiVit, styles.xemLayout]}>
                  Xem bài viết
                </Text>
                <Image
          ...
          <View style={[styles.layoutBlocksVertical, styles.postSpaceBlock]}>
            <View style={styles.commentcell}>
              ...
              <View style={[styles.comment, styles.commentSpaceBlock]}>
                <View style={[styles.nameGroup, styles.nameSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    <Text style={[styles.lMinhTr1, styles.lMinhTr1Typo]}>
                      Lê Minh Trí
                    </Text>
                    <Image
                ...
                <View
                  style={[styles.commentmedia, styles.commentmediaSpaceBlock]}
                >
                  <Image
                  ...
                  <View style={[styles.reacted, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji21.png")}
                      />
                      <Image
                        style={[styles.emojiIcon1, styles.emojiIconLayout]}
                        resizeMode="cover"
                        source={require("../../assets/emoji37.png")}
                      />
                      <Image
            ...
            <View style={styles.commentcell}>
              ...
              <View style={[styles.frameParent, styles.commentSpaceBlock]}>
                <View style={styles.hyperlink}>
                  <Image
                    style={[styles.leftIcon, styles.iconLayout2]}
                    resizeMode="cover"
                  ...
                  />
                  <Text style={[styles.phnHi, styles.xemLayout]}>
                    3 phản hồi
                  </Text>
                </View>
                <Image
                  style={styles.nameChild}
                  resizeMode="cover"
                  source={require("../../assets/ellipse-1862.png")}
                />
                <Text style={[styles.xemThm1, styles.xemLayout]}>Xem thêm</Text>
              </View>
            </View>
            <View style={styles.commentcell}>
              <View style={[styles.tree1, styles.tree1FlexBox]}>
              ...
              <View style={styles.commentavt1}>
                <Image
                  ...
                  source={require("../../assets/avt1.png")}
                />
                <View style={[styles.tree3, styles.treeSpaceBlock]}>
                  <View style={[styles.treeChild, styles.treeBorder]} />
                </View>
              </View>
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={[styles.nameContainer, styles.nameSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    <Text style={[styles.lMinhTr1, styles.lMinhTr1Typo]}>
                      Lê Minh Trí
                    </Text>
            ...
            <View style={styles.commentcell}>
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={styles.nameParent1}>
                  <View style={styles.hyperlink}>
                    <Text style={[styles.fptCamera1, styles.lMinhTr1Typo]}>
                      FPT Camera
                    </Text>
                    <Image
                      style={styles.nameChild}
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text5, styles.labelLayout]}>
                        28/05/2023
                      </Text>
                    </View>
                  </View>
                ...
                <View style={styles.actionSpaceBlock}>
                  ...
                  <View style={[styles.reacted2, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      <Image
                        style={[styles.emojiIcon, styles.iconLayout]}
                        resizeMode="cover"
                  ...
                  <View style={[styles.reacted2, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        style={[styles.emojiIcon1, styles.emojiIconLayout]}
                        resizeMode="cover"
                        source={require("../../assets/emoji39.png")}
                      />
                      <Image
                        style={[styles.emojiIcon2, styles.emojiIconLayout]}
                        resizeMode="cover"
            ...
            <View style={styles.commentcell}>
              ...
              <View style={styles.commentavt1}>
                <Image
                  style={styles.avtIcon}
                  resizeMode="cover"
                  source={require("../../assets/avt8.png")}
                />
                <View style={[styles.tree3, styles.treeSpaceBlock]}>
                  <View style={[styles.treeChild, styles.treeBorder]} />
                </View>
            ...
            <View style={styles.commentcell}>
              ...
              <View style={styles.commentavt1}>
                <Image
                  style={styles.avtIcon}
                  resizeMode="cover"
                  source={require("../../assets/avt9.png")}
                />
                <View style={[styles.tree3, styles.treeSpaceBlock]}>
                  <View style={[styles.treeChild, styles.treeBorder]} />
                </View>
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={[styles.nameContainer, styles.nameSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.text1Clr]}>06:34</Text>
                    </View>
                  </View>
                  <Text style={[styles.choMnhHi, styles.choMnhHiTypo]}>
                    Bình luận con 9
            ...
            <View style={styles.commentcell}>
              ...
              <View style={styles.commentavt1}>
                <Image
                  style={styles.avtIcon}
                  resizeMode="cover"
                  source={require("../../assets/avt10.png")}
                />
                <View style={[styles.tree3, styles.treeSpaceBlock]}>
                  <View style={[styles.treeChild, styles.treeBorder]} />
                </View>
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={styles.nameParent6}>
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.text1Clr]}>06:35</Text>
                    </View>
                  </View>
                  <View
                    style={[
                      styles.commentmedia7,
                      styles.commentmediaSpaceBlock,
                    ]}
                  >
                    <Image
                      style={styles.image1Icon7}
                      resizeMode="cover"
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={[styles.nameContainer, styles.nameSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.text1Clr]}>07:00</Text>
                    </View>
                  </View>
                  <Text style={[styles.choMnhHi, styles.choMnhHiTypo]}>
                    Bình luận con 11
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={[styles.nameContainer, styles.nameSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.text1Clr]}>15:03</Text>
                    </View>
                  </View>
                  <Text style={[styles.choMnhHi, styles.choMnhHiTypo]}>
                    Bình luận con 12
              ...
              <View style={[styles.comment1, styles.commentSpaceBlock]}>
                <View style={[styles.nameContainer, styles.nameSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.text1Clr]}>17:00</Text>
                    </View>
                  </View>
                  <Text style={[styles.choMnhHi, styles.choMnhHiTypo]}>
                    Bình luận con 13
        ...
        <View style={styles.composeBar}>
          <View style={styles.helperText}>
            <Text style={[styles.description, styles.xemLayout]}>
          ...
          <View style={[styles.composeBar1, styles.tree1FlexBox]}>
            ...
            <View style={[styles.composer, styles.composerFlexBox]}>
              <View style={styles.nhpTinNhnWrapper}>
                <Text style={[styles.nhpTinNhn, styles.text1Clr]}>
                  Viết phản hồi
                </Text>
              </View>
              <Image
                style={[styles.emojiIcon78, styles.emojiIcon78Position]}
                resizeMode="cover"
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.emojiIcon78Position]} />
          </View>
        </View>
      </View>
      <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text25, styles.text25Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text25Position]}
            resizeMode="cover"
