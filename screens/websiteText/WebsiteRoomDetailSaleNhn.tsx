...
const WebsiteRoomDetailSaleNhn = () => {
  return (
    <View style={styles.websiteRoomDetailSaleNhn}>
        ...
        <View style={[styles.khungChat, styles.khungChatFlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={[styles.messagecell2, styles.messagecellSpaceBlock]}>
              ...
              <View style={[styles.messageitem2, styles.messageitem2Layout]}>
                <View
                  style={[styles.messageTypetext, styles.helperTextSpaceBlock]}
                >
...
export default WebsiteRoomDetailSaleNhn;
