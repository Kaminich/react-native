...
const WebsiteRoomDetailLog1 = () => {
  return (
    <View style={styles.websiteRoomDetailLog}>
          ...
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              ...
              <View style={styles.logFlexBox}>
                <Text
                  style={[styles.truyCpInternetContainer, styles.xemLayout]}
                >
            ...
            >
              <View style={styles.parentFlexBox}>
                <Text style={[styles.trangTipCn, styles.xemLayout]}>
                  Trang tiếp cận:
                </Text>
              ...
              <View style={[styles.nhMngParent, styles.parentFlexBox]}>
                ...
                <View style={styles.hoChiMinhCityParent}>
                  ...
                  <Text style={[styles.xemThm, styles.linHTypo]}>Xem thêm</Text>
                </View>
              </View>
              <View style={[styles.nhMngParent, styles.parentFlexBox]}>
                <Text style={[styles.trangTipCn, styles.xemLayout]}>
            ...
            <View style={[styles.messagecell, styles.messagecellSpaceBlock]}>
              ...
              <View style={styles.huongnt256Parent}>
                ...
                <View style={[styles.messageitem, styles.messageitemBg]}>
                  <View
                    style={[
                  ...
                  >
                    <Text style={[styles.tiCnH, styles.xemLayout]}>
            ...
            >
              <Text style={[styles.time1, styles.timeClr]}>11:03</Text>
              <View style={[styles.logMessagenormal1, styles.logFlexBox]}>
                <Text style={[styles.xemHotNg, styles.xemLayout]}>
            ...
            >
              ...
              <View style={styles.logFlexBox}>
                <Text style={[styles.bn, styles.textTypo]}>Bạn</Text>
                <Text style={[styles.giTinNhn, styles.xemLayout]}>
            ...
            <View style={[styles.messagecell2, styles.messagecellSpaceBlock]}>
              <View style={[styles.messageitem1, styles.messageitemBg]}>
                <View
                  style={[styles.messageTypetext, styles.helperTextSpaceBlock]}
                >
            ...
            >
              ...
              <View style={styles.logFlexBox}>
                ...
                >
                  ...
                  <Text style={[styles.linH, styles.linHTypo]}>
                    {" "}
                    Liên hệ - FPT Telecom
                  </Text>
                </Text>
            ...
            <View
              style={[styles.messagelogAction1, styles.messagecellSpaceBlock]}
            >
              <Text style={[styles.time, styles.timeClr]}>12:06</Text>
              <View style={styles.logFlexBox}>
                <Text
                  style={[styles.truyCpInternetContainer, styles.xemLayout]}
                >
            ...
            <View
              style={[styles.messagelogAction5, styles.messagecellSpaceBlock]}
            >
              <Text style={[styles.time1, styles.timeClr]}>12:05</Text>
              <View style={[styles.logMessagenormal1, styles.logFlexBox]}>
                <Text style={[styles.thuGn, styles.xemLayout]}>Thu gọn</Text>
                <Image
                  style={[styles.doubleUp, styles.iconLayout]}
                  resizeMode="cover"
                  source={require("../../assets/double-down1.png")}
                />
              </View>
            </View>
          </View>
      ...
      <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text11, styles.text11Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text11Position]}
            resizeMode="cover"
...
export default WebsiteRoomDetailLog1;
