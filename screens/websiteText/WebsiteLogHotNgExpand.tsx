...
const WebsiteLogHotNgExpand = () => {
  return (
    <View style={styles.websiteLogHotNgExpand}>
        ...
        <View style={[styles.khungChat, styles.avt1FlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            <View style={styles.messagelogAction}>
              <Text style={[styles.time, styles.luxTypo]}>11:00</Text>
            ...
            <View style={styles.messagecellFlexBox}>
              <Text style={[styles.time, styles.luxTypo]}>11:02</Text>
              <View style={styles.logMessagenormal}>
                <Text
                  style={[styles.truyCpInternetContainer, styles.textLayout]}
                >
            ...
            <View style={styles.messagecellFlexBox}>
              <Text style={[styles.time, styles.luxTypo]}>11:03</Text>
            ...
            <View style={styles.messagecellFlexBox}>
              <Text style={[styles.time, styles.luxTypo]}>11:04</Text>
              <View style={styles.logMessagenormal2}>
                <Text style={[styles.text6, styles.textTypo1]}>
                  154.214.144.116
                </Text>
            ...
            <View style={[styles.messagelogAction4, styles.messagecellFlexBox]}>
              <Text style={[styles.time, styles.luxTypo]}>12:05</Text>
              <View style={styles.logMessagenormal}>
      ...
      <View style={styles.websiteLogHotNgExpandChild} />
      <View style={[styles.actionSheet, styles.actionSheetPosition]}>
        ...
        <View style={[styles.dsHotNg, styles.dsHotNgSpaceBlock]}>
          <View style={styles.activityFeed}>
            <View style={styles.activityFeedLog}>
              <Image
                ...
                resizeMode="cover"
                source={require("../../assets/frame-42731876721.png")}
              />
              <View style={styles.nameParent}>
          ...
          <View style={[styles.activityFeed1, styles.activitySpaceBlock1]}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
            ...
            <View style={styles.activityFeedLog5}>
              ...
              <View style={styles.content5}>
                ...
                <View style={styles.hyperlink}>
                  ...
                  <View style={[styles.frameView, styles.giDchVSpaceBlock]}>
                    <View style={styles.giLuxWifi6FptTelecomParent}>
                      <Text style={[styles.giLuxWifi1, styles.luxTypo]}>
                        Gói Lux (wifi 6) - FPT Telecom
                      </Text>
                      <Text style={[styles.text19, styles.luxTypo]}>2</Text>
                    </View>
                    <View style={styles.internetCNhnFptTelecomParent}>
                      <Text style={[styles.giLuxWifi1, styles.luxTypo]}>
                        Internet cá nhân - FPT Telecom
                      </Text>
                      <Text style={[styles.text19, styles.luxTypo]}>1</Text>
                    </View>
                    <View style={styles.internetCNhnFptTelecomParent}>
                      <Text style={[styles.giLuxWifi1, styles.luxTypo]}>
                        Liên hệ - FPT Telecom
          ...
          <View style={styles.activitySpaceBlock1}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                ...
                <View style={styles.hyperlink}>
                  ...
                  >
                    ...
                    <Image
                      ...
                      resizeMode="cover"
                      source={require("../../assets/uangledoubledown1.png")}
                    />
                  </View>
                  <View style={[styles.link1Parent, styles.giDchVSpaceBlock]}>
                    <View style={styles.name}>
                      <Text
                        style={[styles.giLuxWifi2, styles.luxTypo]}
                        numberOfLines={1}
                      >
                        Gói Lux (wifi 6) - FPT Telecom
                      </Text>
            ...
            <View style={styles.logCon}>
              <View style={styles.activityFeedLog}>
                ...
                <View style={styles.content5}>
                  <Image
                    style={styles.warningIconLayout}
                    resizeMode="cover"
                    source={require("../../assets/activity-feed--icon23.png")}
                  />
                  <View style={styles.hyperlink}>
                    <Text style={[styles.text28, styles.textLayout]}>
                      31/05/2022 11:00:03
                    </Text>
                    <View style={[styles.content10, styles.giDchVSpaceBlock]}>
                      <Text style={[styles.user, styles.textLayout]}>
                        154.214.144.116
                      </Text>
                      <Text style={[styles.action, styles.textLayout]}>
                ...
                <View style={styles.content5}>
                  ...
                  <View style={styles.hyperlink}>
                    ...
                    <View style={[styles.content10, styles.giDchVSpaceBlock]}>
                      ...
                      <Text
                        style={[styles.object1, styles.textLayout]}
                        numberOfLines={1}
                      >{`HuongNT256 `}</Text>
                    </View>
                    <Text style={[styles.giDchV, styles.giDchVSpaceBlock]}>
              ...
              <View
                style={[styles.activityFeedLog12, styles.activitySpaceBlock]}
              >
                <Image
                  style={styles.activityFeedLogChild}
                  resizeMode="cover"
              ...
              <View style={styles.activitySpaceBlock}>
                ...
                <View style={styles.content5}>
                  <Image
                    style={styles.warningIconLayout}
                    resizeMode="cover"
                    source={require("../../assets/activity-feed--icon25.png")}
                  />
                  <View style={styles.hyperlink}>
                    <Text style={[styles.text28, styles.textLayout]}>
                      31/05/2022 11:03:15
              ...
              <View style={styles.activitySpaceBlock}>
                ...
                <View style={styles.content5}>
                  <Image
                    style={styles.warningIconLayout}
                    resizeMode="cover"
                    source={require("../../assets/activity-feed--icon26.png")}
                  />
                  <View style={styles.hyperlink}>
                    <Text style={[styles.text28, styles.textLayout]}>
                      31/05/2022 11:04:33
            ...
            <View style={styles.activityFeedLog1}>
              <View style={styles.name}>
                ...
                <View style={styles.content1}>
                  ...
                  />
                  <Text style={[styles.thuGn, styles.textLayout]}>Thu gọn</Text>
                </View>
              </View>
            </View>
          </View>
        ...
        <View style={styles.actionSheetfooter}>
          <View style={[styles.buttonParent, styles.dsHotNgSpaceBlock]}>
            <View style={[styles.button1, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text41, styles.textTypo]}>Secondary</Text>
              <Image
            ...
            <View style={[styles.button2, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text42, styles.textTypo]}>Primary</Text>
              <Image
                style={[styles.iconsetplaceholder3, styles.leftIconLayout]}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder5.png")}
...
export default WebsiteLogHotNgExpand;
