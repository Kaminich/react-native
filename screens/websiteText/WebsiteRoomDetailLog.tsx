      ...
      <View style={styles.roomheaderParent}>
        ...
        <View style={[styles.khungChat, styles.khungChatFlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            <View
              style={[styles.messagelogAction6, styles.messagecellSpaceBlock]}
            >
              <Text style={[styles.time6, styles.timeClr]}>12:05</Text>
              <View style={[styles.logMessagenormal1, styles.logFlexBox]}>
                <Text style={[styles.thuGn, styles.textLayout]}>Thu gọn</Text>
                <Image
                  style={[styles.doubleDownIcon, styles.iconLayout]}
                  resizeMode="cover"
      ...
      <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text13, styles.text13Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text13Position]}
            resizeMode="cover"
...
export default WebsiteRoomDetailLog;
