...
const WebsiteRoomDetailTheoDiH = () => {
  return (
    <View style={styles.websiteRoomDetailTheoDiH}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={[styles.khungChat, styles.avt1FlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={styles.messagesocialProfile}>
            ...
            <View style={styles.messagecell1}>
              <View style={[styles.avt1, styles.avt1FlexBox]}>
                <Image
                  style={styles.avtIcon}
                  resizeMode="cover"
...
export default WebsiteRoomDetailTheoDiH;
