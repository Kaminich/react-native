...
const WebsiteRoomDetailLogExpand = () => {
  return (
    <View style={styles.websiteRoomDetailLogExpand}>
          ...
          <View style={styles.room}>
            <View style={styles.roommessageavt}>
              <View style={styles.avt}>
                <Text style={[styles.k, styles.thuTypo]}>1</Text>
              </View>
              <Image
...
export default WebsiteRoomDetailLogExpand;
