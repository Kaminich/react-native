...
const WebsiteRoomDetail3Log = () => {
  return (
    <View style={styles.websiteRoomDetail3Log}>
      <View style={styles.roomheaderParent}>
        ...
        <View style={[styles.khungChat, styles.khungChatFlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            >
              ...
              <View style={[styles.nhMngParent, styles.parentFlexBox]}>
                ...
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../../assets/uinfocircle11.png")}
                />
              </View>
              <View style={[styles.nhMngParent, styles.parentFlexBox]}>
                <Text style={[styles.trangTipCn, styles.textLayout]}>
            ...
            <View
              style={[styles.messagelogAction4, styles.messagecellSpaceBlock]}
            >
              <Text style={[styles.time, styles.timeClr]}>12:05</Text>
              <View style={styles.logFlexBox}>
                <Text
      ...
      <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text16, styles.text16Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text16Position]}
            resizeMode="cover"
...
export default WebsiteRoomDetail3Log;
