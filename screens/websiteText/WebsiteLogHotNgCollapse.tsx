...
const WebsiteLogHotNgCollapse = () => {
  return (
    <View style={styles.websiteLogHotNgCollapse}>
        ...
        <View style={[styles.khungChat, styles.avt1FlexBox]}>
          <View style={styles.layoutBlocksVertical}>
            ...
            <View style={styles.messagecellFlexBox}>
              <Text style={[styles.time, styles.timeClr]}>11:02</Text>
              <View style={styles.logMessagenormal}>
                <Text
                  style={[styles.truyCpInternetContainer, styles.textLayout]}
                >
      ...
      <View style={styles.websiteLogHotNgCollapseChild} />
      <View style={[styles.actionSheet, styles.actionSheetPosition]}>
        ...
        <View style={[styles.dsHotNg, styles.dsHotNgSpaceBlock]}>
          ...
          <View style={[styles.activityFeed1, styles.activitySpaceBlock]}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-42731876717.png")}
              />
              <View style={styles.nameParent}>
                <View style={styles.parent}>
                  <Text style={[styles.text10, styles.textLayout]}>
          ...
          <View style={[styles.activityFeed1, styles.activitySpaceBlock]}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-42731876718.png")}
              />
              <View style={styles.nameParent}>
                <View style={styles.parent}>
                  <Text style={[styles.text10, styles.textLayout]}>
            ...
            <View style={[styles.activityFeedLog5, styles.activitySpaceBlock1]}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                ...
                <View style={styles.hyperlink}>
                  ...
                  <View style={styles.frameView}>
                    <View style={styles.giLuxWifi6FptTelecomParent}>
                      ...
                      <Text style={[styles.text19, styles.timeClr]}>2</Text>
                    </View>
                    <View style={styles.internetCNhnFptTelecomParent}>
                      <Text style={[styles.giLuxWifi1, styles.timeLayout]}>
                        Internet cá nhân - FPT Telecom
                      </Text>
                      <Text style={[styles.text19, styles.timeClr]}>1</Text>
                    </View>
                    <View style={styles.internetCNhnFptTelecomParent}>
                      <Text style={[styles.giLuxWifi1, styles.timeLayout]}>
                        Liên hệ - FPT Telecom
...
export default WebsiteLogHotNgCollapse;
