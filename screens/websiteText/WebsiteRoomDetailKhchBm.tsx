...
const WebsiteRoomDetailKhchBm = () => {
  return (
    <View style={styles.websiteRoomDetailKhchBm}>
            ...
            <View style={[styles.messagecell, styles.messagecellSpaceBlock]}>
              ...
              <View style={[styles.messageitem2, styles.messageitem2Layout]}>
                <View
                  style={[styles.messageTypetext, styles.helperTextSpaceBlock]}
                >
                  <Text style={[styles.tiCnH2, styles.tiCnHTypo]}>Bắt đầu</Text>
                </View>
              </View>
            </View>
            <View
      ...
      <View style={[styles.statusbarIphone13, styles.notchIconPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text9, styles.text9Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text9Position]}
            resizeMode="cover"
...
export default WebsiteRoomDetailKhchBm;
