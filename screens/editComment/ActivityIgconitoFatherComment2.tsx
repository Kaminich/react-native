...
const ActivityIgconitoFatherComment2 = () => {
  return (
    <View style={[styles.activityIgconitoFatherComment, styles.title1Layout]}>
        ...
        <View>
          ...
          <View style={styles.listCell}>
            <Image
              style={[styles.iconRoom, styles.iconLayout1]}
              resizeMode="cover"
              source={require("../../assets/icon-room16.png")}
            />
            <Text style={[styles.label, styles.valueTypo]}>
              Nhãn khách hàng
            </Text>
          ...
          <View style={styles.listCell}>
            <Image
              style={[styles.iconRoom, styles.iconLayout1]}
              resizeMode="cover"
              source={require("../../assets/icon-room17.png")}
            />
          ...
          <View style={styles.listCell}>
            <Image
              ...
              resizeMode="cover"
              source={require("../../assets/icon-room18.png")}
            />
          ...
          >
            ...
            <View style={styles.tabControl}>
              <View style={[styles.tab, styles.tabFlexBox]}>
                ...
                />
                <Text style={[styles.label9, styles.thuTypo]}>Tab 1</Text>
...
`}</Text>
      ...
      <View style={styles.activityIgconitoFatherCommentChild} />
        ...
        <View style={styles.dsHotNg}>
          <View style={styles.activityFeed}>
              ...
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  ...
                  <Image
                    ...
                    resizeMode="cover"
                    source={require("../../assets/4-warning1.png")}
                  />
                </View>
                <View style={styles.content}>
                  <Text style={[styles.user, styles.thuTypo]}>Lê Minh Trí</Text>
                  <Text style={[styles.action, styles.userLayout]}>
                    bình luận
                  </Text>
                  <Text
                    style={[styles.fptCameraH, styles.thuTypo]}
                    numberOfLines={1}
                  >
                    FPT Camera Hà Nội
                  </Text>
            ...
            <View>
              <View style={styles.activityFeedLog}>
                ...
                <View style={styles.content1}>
                  ...
                  <View style={styles.hyperlink}>
                    ...
                    <View style={[styles.content2, styles.giDchVSpaceBlock]}>
                      <Text style={[styles.user, styles.thuTypo]}>
                        Lê Minh Trí
                      </Text>
                      <Text style={[styles.action, styles.userLayout]}>
                        bình luận
                      ...
                      <Text
                        style={[styles.object, styles.thuTypo]}
                        numberOfLines={1}
                      >
                        FPT Camera Hà Nội...
                      </Text>
                    </View>
                    <Text style={[styles.giDchV, styles.giDchVSpaceBlock]}>
              ...
              <View style={styles.activitySpaceBlock}>
                ...
                <View style={styles.content1}>
                  ...
                  <View style={styles.hyperlink}>
                    ...
                    <View style={[styles.content2, styles.giDchVSpaceBlock]}>
                      <Text style={[styles.user2, styles.userLayout]}>
                        <Text
                          style={[styles.thuHng, styles.thuTypo]}
                        >{`Thu Hương `}</Text>
                        <Text style={styles.trLiBnh}>
                          trả lời bình luận của
                        </Text>
                        <Text style={[styles.thuHng, styles.thuTypo]}>
                          {" "}
                          Lê Minh Trí
                        </Text>
                      </Text>
                      <Text style={[styles.action2, styles.userLayout]}>
                        trả lời bình luận của
                      </Text>
                      <Text
                        style={[styles.object, styles.thuTypo]}
              ...
              <View style={styles.activitySpaceBlock}>
                ...
                <View style={styles.content1}>
                  ...
                  <View style={styles.hyperlink}>
                    ...
                    <View style={[styles.content2, styles.giDchVSpaceBlock]}>
                      <Text style={[styles.user3, styles.userLayout]}>
                        <Text
                          style={[styles.thuHng, styles.thuTypo]}
                        >{`Thu Hương `}</Text>
                        <Text style={styles.trLiBnh}>
              ...
              <View style={styles.activitySpaceBlock}>
                ...
                <View style={styles.content1}>
                  <Image
                    style={styles.iconLayout1}
                    resizeMode="cover"
                    source={require("../../assets/activity-feed--icon20.png")}
                  />
                  <View style={styles.hyperlink}>
                    <Text style={[styles.text11, styles.userLayout]}>
                      01/06/2022 08:30:22
                    ...
                    <View style={[styles.content2, styles.giDchVSpaceBlock]}>
                      <Text style={[styles.user3, styles.userLayout]}>
                        <Text
                          style={[styles.thuHng, styles.thuTypo]}
                        >{`HuongNT256 `}</Text>
                        <Text style={styles.trLiBnh}>đã ẩn bình luận của</Text>
                        <Text style={[styles.thuHng, styles.thuTypo]}>
                          {" "}
                          Lê Minh Trí
                        </Text>
              ...
              <View
                style={[styles.activityFeedLog6, styles.activitySpaceBlock]}
              >
                <Image
                  style={styles.activityFeedLogChild}
                  resizeMode="cover"
              ...
              >
                ...
                <View style={styles.content1}>
                  <Image
                    style={styles.iconLayout1}
                    resizeMode="cover"
                    source={require("../../assets/activity-feed--icon19.png")}
                  />
                  <View style={styles.hyperlink}>
                    <Text style={[styles.text11, styles.userLayout]}>
                      02/06/2022 10:02:15
                    ...
                    <View style={[styles.content2, styles.giDchVSpaceBlock]}>
                      <Text style={[styles.user3, styles.userLayout]}>
                        <Text
                          style={[styles.thuHng, styles.thuTypo]}
                        >{`HuongNT256 `}</Text>
                        <Text style={styles.trLiBnh}>đã xóa bình luận của</Text>
                        <Text style={[styles.thuHng, styles.thuTypo]}>
                          {" "}
                          Thu Hương
                        </Text>
            ...
            <View style={styles.activityFeedLog11}>
          ...
          <View style={styles.activityFeed1}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-42731876714.png")}
              />
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  <Text style={[styles.text8, styles.userLayout]}>
            ...
            <View style={styles.activityFeedLog11}>
              <View style={styles.activityFeedMessage}>
                ...
                <View style={styles.content21}>
                  ...
                  />
                  <Text style={[styles.xemThmHot, styles.thuTypo]}>
                    Xem thêm hoạt động
                  </Text>
                </View>
              </View>
          ...
          <View style={styles.activityFeed1}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-4273187672.png")}
              />
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  <Text style={[styles.text8, styles.userLayout]}>
                ...
                <View style={styles.content}>
                  ...
                  <Text
                    style={[styles.fptCameraH2, styles.thuTypo]}
                    numberOfLines={1}
                  >
            ...
            <View style={styles.activityFeedLog15}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
              ...
              <View style={styles.content1}>
                ...
                <View style={styles.hyperlink}>
                  ...
                  <View style={[styles.frameParent4, styles.giDchVSpaceBlock]}>
                    <View style={styles.tabBarParent}>
                      <Text style={[styles.giLuxWifi, styles.text27Typo]}>
                        Gói Lux (wifi 6) - FPT Telecom
                      </Text>
                      <Text style={[styles.text27, styles.text27Typo]}>2</Text>
                    </View>
                    <View style={styles.internetCNhnFptTelecomParent}>
                      <Text style={[styles.giLuxWifi, styles.text27Typo]}>
                        Internet cá nhân - FPT Telecom
                      </Text>
                      <Text style={[styles.text27, styles.text27Typo]}>1</Text>
                    </View>
                    <View style={styles.internetCNhnFptTelecomParent}>
                      <Text style={[styles.giLuxWifi, styles.text27Typo]}>
                        Liên hệ - FPT Telecom
        ...
        <View style={styles.actionSheetfooter}>
          <View style={styles.buttonParent}>
            <View style={[styles.button2, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text39, styles.textTypo]}>Secondary</Text>
              <Image
            ...
            <View style={[styles.button3, styles.buttonFlexBox]}>
              ...
              />
              <Text style={[styles.text40, styles.textTypo]}>Primary</Text>
              <Image
                style={styles.iconsetplaceholder3}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder5.png")}
...
const styles = StyleSheet.create({
  ...
  activityIgconitoFatherCommentChild: {
...
export default ActivityIgconitoFatherComment2;
