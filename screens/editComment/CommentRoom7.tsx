...
Combo `}</Text>
            ...
            <View style={styles.timerpmParent}>
              <View style={styles.timerpm}>
                <Text style={[styles.text, styles.textTypo]}>01/06/2022</Text>
              </View>
            ...
            <View style={styles.commentcell}>
              ...
              <View style={styles.comment}>
                <View style={[styles.nameGroup, styles.nameGroupSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    ...
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.textTypo]}>06:34</Text>
                    </View>
                  </View>
                ...
                <View style={[styles.action, styles.actionSpaceBlock]}>
                  <Text style={[styles.xo020620221100, styles.textTypo]}>
                    Đã xoá: 02/06/2022 11:00
                  </Text>
                </View>
              </View>
            </View>
              ...
              <View style={styles.comment1}>
                ...
                >
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text2, styles.textTypo]}>06:35</Text>
                    </View>
                  </View>
                ...
                <View style={[styles.action1, styles.actionSpaceBlock]}>
                  <View style={styles.option}>
                    <View style={styles.hyperlink}>
                      ...
                      />
                      <Text style={[styles.sa, styles.labelLayout]}>Sửa</Text>
                    </View>
                    <View style={styles.deleteParent}>
                      <Image
                        style={[styles.editIcon, styles.iconLayout2]}
                        resizeMode="cover"
                        source={require("../../assets/delete2.png")}
                      />
                      <Text style={[styles.sa, styles.labelLayout]}>Xóa</Text>
                    </View>
                  </View>
                  <View style={[styles.reacted, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji23.png")}
                      />
                      <Image
                    ...
                    <Text style={[styles.text3, styles.labelLayout]}>3</Text>
                  </View>
                </View>
              ...
              <View style={styles.comment1}>
                <View style={[styles.frameView, styles.nameGroupSpaceBlock]}>
                  <View style={styles.hyperlink}>
                    ...
                    />
                    <View style={styles.timerpm1}>
                      <Text style={[styles.text1, styles.textTypo]}>07:00</Text>
                    </View>
                  </View>
                  <Text style={[styles.choMnhHi, styles.choMnhHiTypo]}>
                    Cho mình hỏi sản phẩm giá bao nhiêu ạ?
                ...
                <View style={[styles.action1, styles.actionSpaceBlock]}>
                  <View style={styles.option}>
                    ...
                    <View style={styles.deleteParent}>
                      ...
                      />
                      <Text style={[styles.sa, styles.labelLayout]}>
                        Trả lời
                      </Text>
                    </View>
                    <View style={styles.deleteParent}>
                    ...
                    <Text style={[styles.sa2, styles.textTypo]}>Đã sửa</Text>
                  </View>
      ...
      <View style={[styles.toast, styles.toastLayout]}>
        ...
        <View style={styles.titleParent}>
          <Text style={[styles.title, styles.titleTypo]}>Đã xóa bình luận</Text>
