                  ...
                  <View style={[styles.reacted, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji26.png")}
                      />
                      <Image
        ...
        <View style={styles.composeBar}>
          ...
          <View style={[styles.composeBar1, styles.tree1FlexBox]}>
            ...
            <View style={[styles.composer, styles.composerBorder]}>
              ...
              <Image
                style={[styles.emojiIcon12, styles.emojiIcon12Position]}
                resizeMode="cover"
          ...
          <View style={styles.homeindicator}>
            <View style={[styles.homeIndicator, styles.emojiIcon12Position]} />
          </View>
        </View>
      </View>
      <View style={[styles.statusbarIphone13, styles.toastPosition]}>
        ...
        <View style={[styles.leftSide, styles.leftSideLayout]}>
          <View style={[styles.statusbarTime, styles.leftSideLayout]}>
            <Text style={[styles.text6, styles.text6Position]}>9:41</Text>
          </View>
        </View>
        <View style={[styles.rightSide, styles.rightSidePosition]}>
          ...
          />
          <Image
            style={[styles.iconMobileSignal, styles.text6Position]}
            resizeMode="cover"
