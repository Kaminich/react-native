...
const CommentRoomNoti2 = () => {
  return (
    <View style={[styles.commentRoomNoti, styles.commentRoomNotiLayout]}>
      <View style={[styles.roomheaderParent, styles.commentRoomNotiChildPosition]}>
...
Combo `}</Text>
          ...
          <View style={[styles.layoutBlocksVertical, styles.text9SpaceBlock]}>
            <View style={styles.commentcell}>
              ...
              <View style={styles.comment}>
                ...
                >
                  <Image
                    style={[styles.image1Icon, styles.commentRoomNotiLayout]}
                    resizeMode="cover"
        ...
        <View style={styles.composeBar}>
          <View style={[styles.helperText, styles.helperTextFlexBox]}>
            <Image
      ...
      <View style={[styles.commentRoomNotiChild, styles.homeIndicatorBg]} />
      <View style={[styles.confirmation, styles.postSpaceBlock]}>
        ...
        <View style={styles.contentParent}>
          <View style={styles.commentavt}>
            <View style={[styles.confirmationIcon, styles.helperTextFlexBox]}>
              <Image
            ...
            <View style={styles.titleParent}>
              <Text style={[styles.title, styles.xemTypo]}>
                Bạn có muốn ẩn bình luận?
              </Text>
              <Text
                style={[styles.text9, styles.textClr]}
              >{`Bình luận vẫn hiển thị với người viết bình luận và bạn bè của họ.
Bình luận này sẽ bị ẩn với mọi người khác.
Các phản hồi về bình luận đó cũng sẽ bị ẩn.`}</Text>
            </View>
          </View>
          <View style={styles.buttonGroup}>
            ...
            <View style={[styles.button1, styles.button1SpaceBlock]}>
              ...
              />
              <Text style={[styles.text11, styles.textTypo]}>Ẩn</Text>
              <Image
                style={[styles.iconsetplaceholder1, styles.iconLayout3]}
                resizeMode="cover"
                source={require("../../assets/iconsetplaceholder8.png")}
...
const styles = StyleSheet.create({
  commentRoomNotiLayout: {
    width: "100%",
    flex: 1,
  },
  commentRoomNotiChildPosition: {
    left: 0,
    width: 375,
  },
  iconLayout3: {
...
export default CommentRoomNoti2;
