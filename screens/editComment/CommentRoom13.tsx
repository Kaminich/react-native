                  ...
                  <View style={[styles.reacted1, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        style={[styles.emojiIcon1, styles.emojiIconLayout]}
                        resizeMode="cover"
                        source={require("../../assets/emoji27.png")}
                      />
                      <Image
                        style={[styles.emojiIcon2, styles.emojiIconLayout]}
                        resizeMode="cover"
      ...
      <View style={[styles.actionSheetcomment, styles.homeindicator1Position]}>
        <View style={styles.actionSheetreactions}>
          ...
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji28.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji29.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji30.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji31.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji32.png")}
          />
          <Image
            style={styles.emojiIcon25}
            resizeMode="cover"
            source={require("../../assets/emoji33.png")}
          />
        </View>
        ...
        <View style={[styles.actionSheetlistCell2, styles.actionSpaceBlock]}>
          <Image
            style={[styles.likeIcon2, styles.iconLayout1]}
            resizeMode="cover"
            source={require("../../assets/message5.png")}
          />
          <View style={styles.labelParent}>
