            ...
            <View style={styles.commentcell}>
              ...
              <View style={styles.comment}>
                ...
                <View style={[styles.action, styles.actionSpaceBlock]}>
                  <Text style={[styles.n010620220830, styles.timeClr]}>
                  ...
                  <View style={styles.eyeParent}>
                    ...
                    />
                    <Text style={[styles.bN, styles.labelLayout]}>Bỏ ẩn</Text>
                  </View>
                </View>
              </View>
            </View>
                ...
                <View style={[styles.action1, styles.actionSpaceBlock]}>
                  <View style={styles.option}>
                    <View style={styles.hyperlink}>
                      ...
                      />
                      <Text style={[styles.bN, styles.labelLayout]}>Sửa</Text>
                    </View>
                    <View style={styles.eyeParent}>
                      <Image
                        style={[styles.editIcon, styles.iconLayout2]}
                      ...
                      />
                      <Text style={[styles.bN, styles.labelLayout]}>Xóa</Text>
                    </View>
                  </View>
                  <View style={[styles.reacted, styles.reactedFlexBox]}>
                    <View style={styles.emojiParent}>
                      ...
                      <Image
                        ...
                        resizeMode="cover"
                        source={require("../../assets/emoji24.png")}
                      />
                      <Image
                ...
                <View style={[styles.action1, styles.actionSpaceBlock]}>
                  <View style={styles.option}>
                    ...
                    <View style={styles.eyeParent}>
                      ...
                      />
                      <Text style={[styles.bN, styles.labelLayout]}>
                        Trả lời
                      </Text>
                    </View>
                    <View style={styles.eyeParent}>
