...
const ActivityFatherComment2 = () => {
  return (
    <View style={[styles.activityFatherComment, styles.title1Layout]}>
...
`}</Text>
      ...
      <View style={styles.activityFatherCommentChild} />
          ...
          <View style={styles.activityFeed1}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-42731876713.png")}
              />
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  <Text style={[styles.text8, styles.userLayout]}>
...
export default ActivityFatherComment2;
