...
const ActivitySonComment2 = () => {
  return (
    <View style={[styles.activitySonComment, styles.title1Layout]}>
            ...
            <View style={styles.tabControl}>
              <View style={[styles.tab, styles.tabFlexBox]}>
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../../assets/social18.png")}
                />
...
`}</Text>
      ...
      <View style={styles.activitySonCommentChild} />
            ...
            <View style={styles.activityFeedLog}>
              ...
              <View style={styles.frameParent1}>
                ...
                <View style={styles.content}>
                  <Text style={[styles.user, styles.thuTypo]}>Thu Hương</Text>
          ...
          <View style={styles.activityFeed1}>
            <View style={styles.activityFeedLog}>
              <Image
                style={styles.activityFeedLogChild}
                resizeMode="cover"
                source={require("../../assets/frame-4273187671.png")}
              />
              <View style={styles.frameParent1}>
                <View style={styles.name}>
                  <Text style={[styles.text8, styles.userLayout]}>
...
export default ActivitySonComment2;
